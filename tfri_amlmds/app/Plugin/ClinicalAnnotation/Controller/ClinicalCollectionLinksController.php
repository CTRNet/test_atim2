...
class ClinicalCollectionLinksController extends ClinicalAnnotationAppController {
	...
	function edit( $participant_id, $collection_id) {
		...
		foreach(array('diagnosis_master_id','consent_master_id','treatment_master_id','event_master_id') as $foreign_key) {
			...
			if(!array_key_exists($foreign_key, $data_for_form['Collection'])) $data_for_form['Collection'][$foreign_key] = null;
		}
