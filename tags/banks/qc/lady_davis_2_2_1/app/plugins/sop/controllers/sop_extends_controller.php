...
class SopExtendsController extends SopAppController {
	...
	function add($sop_master_id=null) {
		...
		if ( !empty($this->data) ) {
			...
			if ( $this->SopExtend->save( $this->data ) ) {
				$this->atimFlash( 'your data has been saved', '/sop/sop_extends/listall/'.$sop_master_id );
			}
		} 
	}
	...
	function edit($sop_master_id=null, $sop_extend_id=null) {
	    ...
	    if (!empty($this->data)) {
			...
			if ($this->SopExtend->save($this->data)) {
				$this->atimFlash( 'your data has been updated','/sop/sop_extends/detail/'.$sop_master_id.'/'.$sop_extend_id);
			}
		} else {
			$this->data = $this_data;
		}
	...
	function delete($sop_master_id=null, $sop_extend_id=null) {
		...
		$this->atimFlash( 'your data has been deleted', '/sop/sop_extends/listall/'.$sop_master_id );
