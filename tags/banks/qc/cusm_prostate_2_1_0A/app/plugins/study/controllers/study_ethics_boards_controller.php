		...
		if ( !empty($this->data) ) {
			...
			if($submitted_data_validates) {
				...
				if ( $this->StudyEthicsBoard->save($this->data) ) {
					$this->atimFlash( 'your data has been saved','/study/study_ethics_boards/detail/'.$study_summary_id.'/'.$this->StudyEthicsBoard->id );
					}
				}
			}
 	}
		...
		if (empty($this->data) ) {
			$this->data = $study_ethics_board_data;
				...
				if($submitted_data_validates) {
					...
					if ( $this->StudyEthicsBoard->save($this->data) ) {
						$this->atimFlash( 'your data has been updated','/study/study_ethics_boards/detail/'.$study_summary_id.'/'.$study_ethics_board_id );
						}
					}
				}
	}
	...
	function delete( $study_summary_id, $study_ethics_board_id ) {
		...
		if($arr_allow_deletion['allow_deletion']) {
			...
			if( $this->StudyEthicsBoard->atim_delete( $study_ethics_board_id ) ) {
				$this->atimFlash( 'your data has been deleted', '/study/study_ethics_boards/listall/'.$study_summary_id );
			} else {
