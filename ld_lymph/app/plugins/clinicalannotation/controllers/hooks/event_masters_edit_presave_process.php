<?php
	...
	if(($event_master_data['EventControl']['disease_site'] == 'ld lymph.') && ($event_master_data['EventControl']['event_type'] == 'initial biopsy')) {
		...
		$conditions = array(
			...
			'EventMaster.diagnosis_master_id != '.$event_master_data['EventMaster']['diagnosis_master_id'],
