...
$final_options = array(
    ...
    'extras' => array(
        'end' => '<input type="radio" name="data[Collection][consent_master_id]" ' . ($consent_found ? '' : 'checked="checked"') . '" value=""/>' . __('n/a')
    )
);
...
$structure_settings['tree'] = array(
    'DiagnosisMaster' => 'DiagnosisMaster'
);

$final_atim_structure = array(
    'DiagnosisMaster' => $atim_structure_diagnosis_detail
);
$final_options = array(
    'type' => 'tree',
    'data' => $diagnosis_data,
    ...
    'links' => $structure_links,
    'extras' => array(
        'end' => '<input type="radio" name="data[Collection][diagnosis_master_id]"  ' . ($found_dx ? '' : 'checked="checked"') . ' value=""/>' . __('n/a')
    )
);
...
$final_options = array(
    ...
    'links' => $structure_links,
    'extras' => array(
        'end' => '<input type="radio" name="data[Collection][treatment_master_id]"  ' . ($found_tx ? '' : 'checked="checked"') . ' value=""/>' . __('n/a')
    )
);
...
$final_options = array(
    ...
    'links' => $structure_links,
    'extras' => array(
        'end' => '<input type="radio" name="data[Collection][event_master_id]"  ' . ($found_event ? '' : 'checked="checked"') . ' value=""/>' . __('n/a')
    )
);
