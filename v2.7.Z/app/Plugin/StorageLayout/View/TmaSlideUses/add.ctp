...
$structure_links = array(
    'top' => '/StorageLayout/TmaSlideUses/add/' . $tma_slide_id,
    'bottom' => array(
...
$parent_settings = array(
    ...
    'settings' => array(
        ...
        'stretch' => false,
        'section_start' => ($tma_slide_id ? false : true)
    )
);
...
$children_settings = array(
    ...
    'settings' => array(
        ...
        "add_fields" => true,
        "del_fields" => true,
        'section_end' => ($tma_slide_id ? false : true)
    )
);
...
while ($data_unit = array_shift($this->request->data)) {
    ...
    $final_options_parent['settings']['name_prefix'] = $data_unit['parent']['TmaSlide']['id'];
    $final_options_children['settings']['name_prefix'] = $data_unit['parent']['TmaSlide']['id'];
    ...
    $final_structure_parent = $tma_slides_atim_structure;
