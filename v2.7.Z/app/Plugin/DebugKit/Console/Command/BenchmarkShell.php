...
class BenchmarkShell extends Shell
{
    ...
    public function getOptionParser()
    {
        ...
        $parser->description(__d('debug_kit', 'Allows you to obtain some rough benchmarking statistics' . 'about a fully qualified URL.'))
            ...
            ->addOption('t', array(
            'default' => 100,
            'help' => __d('debug_kit', 'Maximum total time for all iterations, in seconds.' . 'If a single iteration takes more than the timeout, only one request will be made')
        ))
