                ...
                if ($content) {
                    ...
                    while (! feof($content)) {
                        ...
                        if (substr($line, 0, 11) === date('Y-m-d ') && $state === 0) {
                            ...
                            if ((time() - $t < 3600)) {
                                $state = 1;
                                $currentLog = '<div class="cake-debug-output">' . '   <div class="minus-button"><a href="javascript:void(0)" class="debug-button">-</a></div>' . '<span class="debug-kit-log-file-span">' . $line . '</span>';
                            }
                    ...
                    fclose($content);
                    $s .= '<div class="cake-debug-output">' . '<div class="minus-button"><a href="javascript:void(0)" class="debug-button">-</a></div>' . '<h1>' . $filename . '</h1>' . $log[$filename] . '</div>';
                }
            }
        }
        return $s;
