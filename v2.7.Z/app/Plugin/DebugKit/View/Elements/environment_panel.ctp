...
if (! empty($content['app'])) {
    ...
    echo $this->Toolbar->table($cakeRows, $headers, array(
        'title' => 'Application Environment Vars'
    ));
} else {
...
if (! empty($content['cake'])) {
    ...
    echo $this->Toolbar->table($cakeRows, $headers, array(
        'title' => 'CakePHP Environment Vars'
    ));
} else {
...
if (! empty($content['php'])) {
    ...
    echo $this->Toolbar->table($phpRows, $headers, array(
        'title' => 'CakePHP Environment Vars'
    ));
} else {
