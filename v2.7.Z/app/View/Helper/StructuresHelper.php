                                    ...
                                    if ($table_row_part['type'] == "checkbox") {
                                        ...
                                        if ($table_row_part['type'] == "yes_no" || $table_row_part['type'] == "y_n_u") {
                                            ...
                                            $display = $this->Form->input($field_name, array_merge($table_row_part['settings'], array(
                                                'type' => 'hidden',
                                                'value' => ""
                                            ))) . __('yes', true) . $this->Form->input($field_name, array_merge($table_row_part['settings'], array(
                                                'type' => 'checkbox',
                                                'value' => "y",
                                                'hiddenField' => false,
                                                'checked' => $current_value == "y" ? true : false
                                            ))) . __('no', true) . $this->Form->input($field_name, array_merge($table_row_part['settings'], array(
                                                'type' => 'checkbox',
                                                'value' => "n",
                                                'hiddenField' => false,
                                            ...
                                            if ($table_row_part['type'] == "y_n_u") {
                                                $display .= __('unknown', true) . $this->Form->input($field_name, array_merge($table_row_part['settings'], array(
                                                    'type' => 'checkbox',
                                                    'value' => "u",
                                                    'hiddenField' => false,
            ...
            foreach ($link_array as $link_label => &$link_location) {
                ...
                if (AppController::checkLinkPermission($link_location) || strpos($link_location, "javascript:") === 0) {
                    ...
                    $html_attributes = array(
                        'title' => strip_tags(html_entity_decode(__($link_name, true), ENT_QUOTES, "UTF-8"))
                    );
...
;
                        ...
                        $link_results[$link_label] = $this->Html->link('<span class="icon16 ' . $class . '"></span>' . __($link_label, true), // title
$link_location, // url
$html_attributes, // options
$confirmation_msg) // confirmation message
;
