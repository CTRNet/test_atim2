...
//Notes:
	...
	$filee = fopen("../../app/locale/eng/LC_MESSAGES/default.po", "w+t") or die("english file error");
	$filef = fopen("../../app/locale/fre/LC_MESSAGES/default.po", "w+t") or die("french file error");
