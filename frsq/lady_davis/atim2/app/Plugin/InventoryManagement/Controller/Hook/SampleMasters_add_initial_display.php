...
if ($sample_control_data['SampleControl']['sample_category'] == 'specimen' && ! empty($collection_data['Collection']['collection_datetime'])) {
    ...
    $this->request->data['SpecimenDetail']['reception_datetime_accuracy'] = in_array($collection_data['Collection']['collection_datetime_accuracy'], array(
        'i',
        'c'
    )) ? 'h' : $collection_data['Collection']['collection_datetime_accuracy'];
}
...
if ($sample_control_data['SampleControl']['sample_type'] == 'blood') {
    ...
    $existing_collection_bloods = $this->SampleMaster->find('all', array(
        'conditions' => array(
    ...
    if (in_array($sample_control_data['SampleControl']['sample_type'], array(
        ...
        $existing_blood_derivative = $this->SampleMaster->find('first', array(
            'conditions' => array(
                'SampleMaster.collection_id' => $collection_id,
