...
$header = array('title' => __('cci code picker', true), 'description' => __('select a cci code', true));
$index_link_prefix = "/codingicd/CodingCcis/search/";
$links = array(
	'index' => array('detail' => $index_link_prefix.'%%CodingIcd.id%%'),
	'bottom' => array('back' => '/codingicd/CodingCcis/tool/'.$use_icd_type));
