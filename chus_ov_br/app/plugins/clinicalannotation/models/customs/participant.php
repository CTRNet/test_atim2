...
class ParticipantCustom extends Participant {
	...
	function summary($variables=array()){
		...
		if ( isset($variables['Participant.id']) ) {
			...
			$result['FunctionManagement']['frsq_br_nbr'] = null;
			$result['FunctionManagement']['frsq_ov_nbr'] = null;
			...
			foreach($identifiers as $identifier){
				switch($identifier['MiscIdentifierControl']['misc_identifier_name']) {
					case '#FRSQ BR':
						$result['FunctionManagement']['frsq_br_nbr'] = $identifier['MiscIdentifier']['identifier_value'];
						break;
					case '#FRSQ OV':
						$result['FunctionManagement']['frsq_ov_nbr'] = $identifier['MiscIdentifier']['identifier_value'];
						break;
					default:	
				}
			}
