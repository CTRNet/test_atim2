...
if ($sample_data['SampleMaster']['procure_created_by_bank'] == 's') {
    $this->flash(__('a sample created by system/script to migrate data from the processing site can not be edited'), "/InventoryManagement/SampleMasters/detail/$collection_id/$sample_master_id", 5);
    return;
}
