<?php 
	...
	**/
	...
	$bottom_links = array(
		...
		'print easyblood labels'	=> array('link' => '/InventoryManagement/SampleMasters/printSampleLabels/model:Collection/id:'.$atim_menu_variables['Collection.id'], 'icon' => 'barcode'),
