...
class MenusController extends AppController {
	...
	public $components = array('Session', 'SessionAcl');
	public $uses = array('Menu', 'Announcement');
	...
	public function index($set_of_menus = null) {
		if (!$set_of_menus) {
			...
			$this->set('due_messages_count', $participant_message_model->find('count', array(
				'conditions' => array(
					...
					'ParticipantMessage.due_date <' => date("Y-m-d H:i:s")
				)
			)));
