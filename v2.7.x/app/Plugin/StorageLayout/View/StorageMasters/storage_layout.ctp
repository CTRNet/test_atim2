...
<div style="display: table; vertical-align: top;">
    <div style="display: table-row;" id="firstStorageRow" data-storage-url="<?php echo $this->here; ?>"
         data-ctrls="true">
        <div style="display: table-cell;" class='loading'>--- <?php echo __('loading'); ?>---</div>
    </div>
    <div style="display: table-row;">
        <div style="display: table-cell; padding: 10px 0;">
            <span class="button" id="btnPickStorage"
                  style="width: 80%;"><?php echo(__("pick a storage to drag and drop to")); ?></span>
        </div>
    </div>
...
$bottom['export as CSV file (comma-separated values)'] = sprintf("javascript:setCsvPopup('/StorageLayout/StorageMasters/storageLayout/" . $atim_menu_variables['StorageMaster.id'] . "/0/1/');",
	0);
