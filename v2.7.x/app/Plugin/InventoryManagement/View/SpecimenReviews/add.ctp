...
$structure_links = array(
	'top' => '/InventoryManagement/SpecimenReviews/add/' . $atim_menu_variables['Collection.id'] . '/' . $atim_menu_variables['SampleMaster.id'] . '/' . $atim_menu_variables['SpecimenReviewControl.id'] . '/',
	'bottom' => array(
		'cancel' => '/InventoryManagement/SpecimenReviews/listAll/' . $atim_menu_variables['Collection.id'] . '/' . $atim_menu_variables['SampleMaster.id'] . '/',
	)
);
...
$structure_settings = array(
	...
	'tabindex' => '1000',
	'header' => __($review_control_data['SampleControl']['sample_type'],
			null) . ' - ' . __($review_control_data['SpecimenReviewControl']['review_type'], null),
