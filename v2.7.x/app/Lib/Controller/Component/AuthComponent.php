 ...
 */
	protected function _unauthorized(Controller $controller) {
		...
		if ($this->unauthorizedRedirect === true) {
         ...
         // ATiM start-----
         // ATIM patch - I'm not sure where the bug is "by design", but controller->referer returns
         // the full prefix past hostname and later router::url reprepends it to the url. This causes
         // erroneous redirection on unauthorized routes. This patch fixes that.
         $baseUrl = Router::url('/');
