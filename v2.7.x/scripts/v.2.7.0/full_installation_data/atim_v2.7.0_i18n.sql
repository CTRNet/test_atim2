...
-- Dumping data for table atim.i18n: ~3,132 rows (approximately)
...
INSERT INTO `i18n` (`id`, `page_id`, `en`, `fr`) VALUES
	...
	('a special parameter could not be applied because relations between %s and its children node are shared', '', 'A special paremeter could not be applied because relations between %s and its children node are shared.', 'Un paramètre spécial n\'a pas pu être appliqué car les relations entre %s et son noeud enfant sont partagées.'),
	...
	('a user name can not be changed', '', 'A user name can not be modified', 'Un nom d\'utilisateur ne peut pas être modifié'),
	...
	('a valid username is required, between 5 to 15, and a mix of alphabetical and numeric characters only', '', 'A valid username is required, between 5 to 15, and a mix of alphabetical and numeric characters only.', 'Un nom d\'utilisateur valide est requis composé de 5 à 15 caractères et un mélange de caractères alphabétiques et numériques uniquement.'),
	...
	('access to aliquot', '', 'Access to Aliquot', 'Accéder à l\'aliquot'),
	...
	('adding notes to a temporary browsing automatically moves it towards the saved browsing list', '', 'Adding notes to a temporary browsing automatically moves it towards the saved browsing list.', 'Ajouter des notes à une navigation temporaire la déplace automatiquement vers la liste des navigations enregistrées.'),
	...
	('additional pathologic findings', '', 'Additional Pathologic Findings', 'Découvertes pathologiques supplémentaires'),
	('address', '', 'Address', 'Adresse'),
	('add_order_items_info', '', 'To add items in batch, you may use query tools batch actions.', 'Pour ajouter des items en lot, vous pouvez utiliser les traitement par lots des outils de requêtes.'),
	...
	('aliquot(s) without a proper consent', '', 'Aliquot(s) without a proper consent', 'Aliquot(s) sans consentement approprié'),
	('aliquots', '', 'Aliquots', 'Aliquots'),
	('aliquots data', '', 'Aliquots Data', 'Données des aliquots'),
	...
	('all', '', 'All', 'Tout'),
	('all (participant, consent, diagnosis and treatment/annotation)', '', 'All (Participant, Consent, Diagnosis and Treatment/Annotation)', 'Tout (participant, Consentement, Diagnotic, Traitement/Annotation)'),
	...
	('ancillary studies specify', '', 'Specify', ''),
	...
	('are you sure you want to reset?', '', 'Are you sure you want to reset?', 'Êtes-vous sûr de vouloir réinitialiser?'),
	('arm', '', 'Arm', 'Bras'),
	...
	('at least one collection is linked to that annotation', '', 'At least one collection is linked to that annotation.', 'Au moins une collection est liée à cette annotation.'),
	...
	('at least one collection is linked to that treatment', '', 'At least one collection is linked to that treatment.', 'Au moins une collection est liée à ce traitement.'),
	...
	('at least one record has to be created', '', 'At least one record has to be created', 'Au moins une donnée doit être crée'),
	...
	('atim_preset_readonly', '', 'All functions names containing add, batch, edit, define, delete, realiquot, remove, or save will de denied of access.', 'Toutes les fonctions dont le nom contient add, batch, edit, define, delete, realiquot, remove, ou save seront refusées d\'accès.'),
	('atim_preset_reset', '', 'The master node is defined as "Allow" and all other nodes are cleared.', 'Le noeud principal est défini comme "Permettre" et tous les autres noeuds sont effacés.'),
	...
	('bad internet explorer version msg', '', 'You need to use Internet Explorer 8+. If you already have such a version, make sure Compatibility View is turned off.', 'Vous devez utiliser Internet Explorer 8+. Si vous avez déjà une telle version, assurez-vous que le mode de compatibilité est désactivé.'),
	('bank', '', 'Bank', 'Banque'),
	('banks', '', 'Banks', 'Banques'),
	('barcode', '', 'Barcode', 'Code à barres'),
	('barcode is required', '', 'The barcode is required!', 'Le code à barres est requis'),
	('barcode is required and should exist', '', 'Barcode is required and should be the barcode of an existing aliquot!', 'Le code à barres est requis et doit exister!'),
	('barcode must be unique', '', 'The barcode must be unique!', 'Le code à barres doit être unique!'),
	('barcode size is limited', '', 'The barcode size is limited!', 'La taille du code à barres est limitée!'),
	('base', '', 'Base', 'Base'),
	...
	('batch_alter_msg', '', 'Some batch functions permissions were altered based on their unit counterpart.', 'Les permissions de certaines fonctions en lot on été altérées étant donné l\'était de leur contrepartie unitaire.'),
	('batch_edit_confirmation_msg', '', 'Batch edit operations are not reversible. Do you want to continue?', 'Les opérations de modification en lot ne peuvent pas être annulées. Souhaitez-vous continuer?'),
	('benign', '', 'Benign', 'Bénin'),
	...
	('breast tissue slide review', '', 'Breast Tissue Slide Review', 'Analyse des lame de tissu de sein'),
	...
	('by the time you submited your selection, the identifier was either used or removed from the system', '', 'By the time you submited your selection, the identifier was either used or removed from the system.', 'Pendant que vous choisissiez un identifiant, votre choix a été utilisé ou retiré du système.'),
	('cache has been cleared', '', 'Cache has been cleared', 'Les fichiers temporaires ont été supprimés'),
	('calculation of different aliquots spent times', '', 'Summary gathering aliquot spent times like \'Collection to Storage Spent Time\', \'Creation to Storage Spent Time\', etc.', 'Résumé contenant des temps écoulés tel que \'Le temps entre la collection et l\'entreposage\', etc.'),
	...
	('cap report - colon/rectum - excisional biopsy', '', 'CAP Report - Colon/Rectum (Excisional Biopsy)', ''),
	...
	('cap report - perihilar bile duct', '', 'CAP Report - Perihilar Bile Duct', ''),
	...
	('clinical history', '', 'Clinical History', 'Historique clinique'),
	...
	('clin_help_other contact type', '', 'Other means through which a patient/participant or family is contacted for follow-up or survival information.', 'Autres moyens par lesquels un patient/participant ou sa famille est contactée pour le suivi ou pour les informations de survie.'),
	...
	('comorbidity', '', 'Comorbidity', 'Comorbidité'),
	...
	('confidential data', '', 'Confidential Data', 'Données confidentielles'),
	...
	('conflict detected in storage [%s] at position [%s, %s]', '', 'Conflict detected in storage [%s] at position [%s, %s].', 'Conflit détecté dans l\'entreposate [%s] à la position [%s, %s].'),
	...
	('created (into the system)', '', 'Created (into the system)', 'Créé (dans le système)'),
	...
	('created_samples_nbr_help', '', 'Number of either specimens collected during the defined period or derivatives created during this same period.', 'Nombre de spécimens récoltés au cours de la période définie ou de dérivés créés au cours de cette même période.'),
	...
	('custom dropdown list management', '', 'Dropdown List Configuration', 'Gestion des listes de valeurs'),
	...
	('date that is selected by default when adding order lines', '', 'Date that is selected by default when adding order lines.', 'Date qui sera sélectionnée par défaut lors d\'ajout de lignes de commandes.'),
	('date/start date', '', 'Date/Start date', 'Date/Date de commencement'),
	...
	('default study / project', '', 'Default Study/Project', 'Étude/Projet (par défaut)'),
	...
	('delete unmerged identifiers and profile of the merged participant', '', 'Delete unmerged identifiers and profile of the merged participant', 'Supprimer les identificateurs non fusionnées et le profil du participant fusionné'),
	('deleted lab book is linked to a derivative', '', 'Your data cannot be deleted! <br>Derivative data are linked to the deleted lab book.', 'Vos données ne peuvent être supprimées! <br>Des dérivés sont attachés à votre cahier de laboratoire.'),
	('deleted lab book is linked to a realiquoted aliquot', '', 'Your data cannot be deleted! <br>Realiquoted aliquots are linked to the deleted lab book.', 'Vos données ne peuvent être supprimées! <br>Des aliquot \'réaliquotés\' sont attachés à votre cahier de laboratoire.'),
	...
	('derivative creation data exists for the deleted aliquot', '', 'Your data cannot be deleted! <br>Derivative creation data exists for the deleted aliquot.', 'Vos données ne peuvent être supprimées! <br>Des données création d\'un dérivé existe pour votre aliquot.'),
	...
	('diagnosis_event_relation_type_help', '', 'Allow to define the type of relation existing between the studied data (treatment, annotation) and the displayed diagnosis. Diagnosis flagged as \'Event\' has been specifically linked to the studied data.', 'Permet de définir le type de relation existant entre les données étudiées (traitement, annotation) et les diagnostices affichés. Le diagnostic marqué comme \'Événement\' a été spécifiquement liée aux données étudiées.'),
	...
	('distal bile duct margin', '', 'Distal Bile Duct Margin', ''),
	('distal margin', '', 'Distal Margin', ''),
	('distal pancreatic margin', '', 'Distal Pancreatic Margin', ''),
	('distal pancreatic resection margin', '', 'Distal Pancreatic Resection Margin', ''),
	('distance from closest margin mm', '', 'Distance From Closest Margin (mm)', ''),
	...
	('distance of invasive carcinoma from closest margin mm', '', 'Distance Of invasive Carcinoma From Closest Margin (mm)', ''),
	...
	('dropdown_config_desc', '', 'To have the list ordered alphabetically with the displayed values, check the "Alphabetcical ordering" option. Otherwise, uncheck it and use the cursor to drag the lines in the order you want the options to be displayed.', 'Pour que la liste soit ordinnée alphabétiquement par les valeurs affichées, cochez l\'option "Ordonnancement alphabétique". Sinon, décochez la et utilisez le curseur pour déplacer les lignes dans l\'ordre d\'affichage que vous voulez.'),
	('drug', '', 'Drug', 'Médicament'),
	('drug administration', '', 'Drug Administration', 'Administration de médicament'),
	('drug is defined as a component of at least one chemotherapy protocol', '', 'The drug is defined as a component of at least one chemotherapy protocol!', 'Le médicament est défini comme étant le composant d\'au moins un protocole de chimiothérapie!'),
	('drug is defined as a component of at least one participant chemotherapy', '', 'The drug is defined as a component of at least one participant chemotherapy!', 'Le médicament est défini comme étant le composant d\'au moins une chimiothérapie de participant!'),
	...
	('dx_laterality', '', 'The side of the body in which the tumour is located in paired organs or skin sites.', 'Le côté du corps où la tumeur est située dans les cas des organes en paires ou les sites de tissus.'),
	('dx_method', '', 'Diagnosis Method', 'Méthode de diagnostic'),
	('dysplasia', '', 'Dysplasia', ''),
	('dysplasia adenoma', '', 'Dysplasia Adenoma', ''),
	...
	('dysplasia carcinoma in situ not identified at bile duct margin', '', 'Dysplasia carcinoma in situ not identified at bile duct margin', ''),
	('dysplasia carcinoma in situ present at bile duct margin', '', 'Dysplasia carcinoma in situ present at bile duct margin', ''),
	('edit', '', 'Edit', 'Modifier'),
	...
	('error_fk_consent_linked_collection', '', 'Your data cannot be deleted! This consent is linked to a collection.', 'Vos données ne peuvent être supprimées! Ce consentement est attaché à une collection.'),
	('error_fk_diagnosis_linked_collection', '', 'Your data cannot be deleted! This diagnosis is linked to a collection.', 'Vos données ne peuvent être supprimées! Ce diagnostic est attaché à une collection.'),
	('error_fk_diagnosis_linked_events', '', 'Your data cannot be deleted! This diagnosis is linked to a annotation event.', 'Vos données ne peuvent être supprimées! Ce diagnostic est attaché à une annotation.'),
	('error_fk_diagnosis_linked_treatment', '', 'Your data cannot be deleted! This diagnosis is linked to a treatment.', 'Vos données ne peuvent être supprimées! Ce diagnostic est attaché à un traitement.'),
	...
	('error_fk_participant_linked_collection', '', 'Your data cannot be deleted! Linked collection record exists for this participant.', 'Vos données ne peuvent être supprimées! Des données de collection existent pour votre participant.'),
	('error_fk_participant_linked_consent', '', 'Your data cannot be deleted! The participant you are trying to delete is linked to an existing consent.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un consentement!'),
	('error_fk_participant_linked_contacts', '', 'Your data cannot be deleted! Linked contact record exists for this participant. Please note some contacts may be confidential and hidden.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un contact! Certains contacts peuvent être confidentiels et caché.'),
	('error_fk_participant_linked_diagnosis', '', 'Your data cannot be deleted! Linked diagnosis record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un diagnostic!'),
	('error_fk_participant_linked_events', '', 'Your data cannot be deleted! Linked annotation event record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à une annotation!'),
	('error_fk_participant_linked_familyhistory', '', 'Your data cannot be deleted! Linked family history exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à une historique familiale!'),
	('error_fk_participant_linked_identifiers', '', 'Your data cannot be deleted! Linked identifier record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un identifiant!'),
	('error_fk_participant_linked_messages', '', 'Your data cannot be deleted! Linked message record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un message!'),
	('error_fk_participant_linked_reproductive', '', 'Your data cannot be deleted! Linked reproductive history record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à une donnée de gynécologie!'),
	('error_fk_participant_linked_treatment', '', 'Your data cannot be deleted! Linked treatment record exists for this participant.', 'Vos données ne peuvent être supprimées! Le participant que vous essayez de supprimer est lié à un traitement!'),
	...
	('error_range_ageatmenopause', '', 'Error - Age at menopause must be between 10 and 100!', 'Erreur - Âge de la ménopause doit être entre 10 et 100!'),
	...
	('export as CSV file (comma-separated values)', '', 'Export displayed data as CSV file (Comma-separated values)', 'Exporter les données affichées comme fichier CSV (Comma-separated values)'),
	('extra nodal invasion', '', 'Extra Nodal Invasion', 'Invasion extranodale'),
	('extrahepatic bile duct', '', 'Extrahepatic Bile Duct', ''),
	('extrapancreatic', '', 'Extrapancreatic', ''),
	('eye', '', 'Eye', 'Oeil'),
	...
	('fields values of the first section have been applied to all other sections', '', 'Fields values of the first section have been applied to all other sections!', 'Les valeurs des champs de la première section ont été appliquées à toutes les autres sections!'),
	('fields values of the section below will be applied to all other sections if entered and will replace sections fields values', '', 'Fields values of the section below will be applied to all other sections if entered (Will replace following sections fields values)!', 'Les valeurs des champs de la section ci-dessous seront appliquées à toutes les autres sections si saisies (Remplaceront les valeurs des champs des sections suivantes)!'),
	...
	('file_not_auth_msg', '', 'You are not authorized to open file (%1$s)', 'Vous n\'êtes pas authorisé à ouvrir le fichier (%1$s)'),
	('file_not_found', '', 'File not found', 'Fichier introuvable'),
	('file_not_found_err_msg', '', 'The file you are trying to get was not found (%1$s)', 'Le fichier que vous tentez d\'obtenir est introuvable (%1$s)'),
	...
	('for any action you take (%s, %s, csv, etc.), all matches of the current set will be used', '', 'For any action you take (%s, %s, CSV, etc.), all matches of the current set will be used', 'Peu importe l\'action que vous sélectionnez (%s, %s, CSV, etc.), tous les résultats de l\'ensemble présent seront utilisés'),
	...
	('functional type', '', 'Functional Type', 'Type fonctionnel'),
	...
	('help default study', '', 'Study that is selected by default when adding order lines.', 'Étude qui est sélectionnée par défaut lorsque des lignes de commandes sont ajoutées.'),
	('help visible', '', 'Help Visible', 'Aide visible'),
	('help_age at dx', '', 'The individual\'s age, in years, at the time of diagnosis.', 'L\'âge de l\'individu, en années, au moment du diagnostic.'),
	('help_age at first parturition', '', 'Age at completion of first fullterm pregnancy expressed in number of years since mother\'s birth.', 'L\'âge à la complétion de la première grossesse complète, calculé en années d\'après la date de naissance de la mère'),
	('help_age at last parturition', '', 'Age at completion of last fullterm pregnancy expressed in number of years since mother\'s birth.', 'L\'âge à la complétion de la dernière grossesse complète, calculé en années d\'après la date de naissance de la mère'),
	('help_age at menarche', '', 'By a woman\'s recollection, the age at the time of first menstrual period, expressed in number of years since birth.', 'Au souvenir de la femme, l\'âge auquel a eu lieu la première période de menstruation, calculé en années d\'après la date de naissance'),
	('help_age at menopause', '', 'By a woman\'s recollection, the age at the time of menopause expressed in number of years since birth.', 'Au souvenir de la femme, l\'âge auquel la ménopause a eu lieu, calculé en années d\'après la date de naissance'),
	('help_age_at_dx', '', 'Age at which the related family member\'s condition or disease was diagnosised', 'Âge auquel la condition ou la maladie du membre de la famille a été diagnostiqué'),
	('help_ajcc edition', '', 'Edition of the AJCC staging manual used to stage the tumour.', 'Édition du manuel de stadification AJCC utilisée pour la détermination du stade de la tumeur.'),
	('help_chemo_completed', '', 'Indicates whether the chemotherapy treatment plan was completed.', 'Indique si le plan de traitement de chimiothérapie a été complété'),
	...
	('help_clinical_stage_summary', '', 'The anatomical extent of disease at diagnosis based on the previously coded T, N and M stage categories, as represented by a code.', 'L\'étendue de la maladie au niveau anatomique au diagnostic basé sur les catégories de stade T, N et M, telle que représentée par un code'),
	('help_cod_icd10_code', '', 'The disease or injury which initiated the train of morbid events leading directly to a person\'s death or the circumstances of the accident or violence which produced the fatal injury, as represented by a code.', 'La maladie ou la blessure qui a initié la série d\'événements de morbidité, menant directement au décès de la personne ou les circonstances de l\'accident ou violence ayant produit une blessure fatale, telle que représentée par un code'),
	('help_collaborative staged', '', 'Indicates whether or not the tumour was staged using the Collaborative Staging System.', 'Indique si la tumeur a été stadifiée, ou non, en utilisant le Collaborative Staging System'),
	('help_completed_cycles', '', 'The total numeric count of chemotherapy cycles completed.', 'Le total numérique des cycles de chimiothérapie complétés'),
	('help_config_language', '', 'Select your preferred language for use within ATiM.', 'Sélectionnez la langue que vous préférez utiliser pour ATiM'),
	('help_confirmation source', '', 'The person, organization or other reporting agency where the vital status information was obtained.', 'La personne, l\'organisation ou une autre entité où les informations vitales ont été obtenues.'),
	('help_consent person', '', 'Name of biobank staff member leading the participant through the informed consent process.', ''),
	('help_consent_method', '', 'Method by which informed consent was obtained.', 'Méthode par laquelle le consentement a été obtenu'),
	('help_consent_signed_date', '', 'Date on which the participant signed and authorized consent to participate in the banking program.', 'Date à laquelle le participant a signé et autorisé le consentement pour participer au programme de banque'),
	('help_consent_status', '', 'Indication of the participants status in the informed consent process.', 'Indication du statut du participant dans le processus de consentement'),
	('help_contact_name', '', 'The identifying label given to the contact.', 'L\'étiquette identifiante donnée au contact'),
	('help_contact_type', '', 'Means through which a patient/participant or family is contacted for follow-up or survival information.', 'Moyen par lequel un patient/participant ou la famille est contactée pour suivi ou pour les informations de survie'),
	('help_country', '', 'Country in which the contact resides.', 'Le pays dans lequel le contact réside'),
	('help_created', '', 'Datetime stamp of when the record was first created in the system.', 'Horodatage du moment où l\'enregistrement a été créé dans le système'),
	('help_csv_encoding', '', 'Defines the character encoding for CSV files. Unless you\'re having characters problems, ISO-8859-1 is recommended. Otherwise switch to UTF-8. However note that Microsoft Excel hardly works with UTF-8.', 'Défini l\'encodage des caractères pour les fichiers CSV. À moins que vous n\'ayez des problèmes, ISO-8859-1 est recommandé. Sinon, passez à UTF-8. Notez toutefois que Microsoft Excel fonctionne difficilement avec UTF-8.'),
	('help_csv_export_type', '', '"Visible columns" will only export columns visible on the screen while "All" will export every columns. (When using "All", some fields might not be user readable data.)', '"Colonnes visibles" exportera seulement les colonnes visibles à l\'écran tandis que "Tout" exportera toutes les colonnes. (Quand l\'option "Tout" est utilisée, certains champs peuvent contenir des données non lisibles pour les utilisateurs.)'),
	('help_csv_redundancy', '', 'Defines how relations causing redundancy will be exported. "Multiple line" will generate a file the same way the display is rendered. "Same line" let you select nodes to export and all entries related to the primary line will be exported on the same line with incrementing labels.', 'Défini comment seront exportés les relations provoquant des redondances. "Multi-lignes" génèrera un fichier comparable à la manière dont les données sont affichées. "Même ligne" vous laisse choisir les noeuds à exporter et chaque élément rattaché à l\'élément du noeud primaire sera exporté sur la même ligne avec des titres incrémentaux.'),
	('help_date captured', '', 'Date the reproductive history was collected or updated from clinical information.', 'Date à laquelle l\'historique de reproduction a été recueilli ou mis à jour à partir de l\'information clinique'),
	('help_date of birth', '', 'The date of birth of the participant.', 'La date de naissance du participant'),
	('help_date of death', '', 'The date of death of the participant.', 'La date du décès du participant'),
	('help_date_first_contact', '', 'Date on which the participant was approached to donate to the biobank.', 'Date à laquelle le participant a été approché pour donner à la biobanque'),
	('help_date_of_referral', '', 'Date the participant was referred to the bio-banking program by the surgical office or self-referred.', 'Date à laquelle le participant a été référé au programme de biobanque'),
	('help_define_csv_separator', '', 'When exporting data to file from the Query Tool this value is used as a separator between fields.', 'Lors de l\'export de données vers un fichier CSV, cette valeur servira à séparer les champs'),
	('help_define_datetime_input_type', '', 'Sets how date information is captured throughout the application. Selecting textual will allow direct input of date values where dropdown will force a select drop down list.', 'Définit de quelle manière les informations de dates et de temps sont capturées à travers l\'application. Textuel permet une entrée textuelle directe tandis que menu déroulant force la sélection à travers divers menus déroulants'),
	('help_define_date_format', '', 'Select your preferred date format for display and input. Note that all values will be saved to the database using the YYYY-MM-DD format regardless of your user preference.', 'Définit l\'ordre d\'affichage des dates.'),
	('help_define_decimal_separator', '', 'ATiM supports both period (.) and comma (,) for use as a decimal separator.', 'ATiM supporte le point (.) et la virgule (,) pour séparer les décimales'),
	('help_define_pagination_amount', '', 'Sets the number of results to display per page on index forms.', 'Définit le nombre par défaut de résultats affichés par page'),
	('help_define_show_advanced_controls', '', 'Toggles the advanced search options on all search forms. This includes the AND/OR options and toggles for exact matches vs pattern matching on text field searches.', 'Définit si les options avancées de recherche sont affichées. Celles-ci sont les options ET/OU ainsi que l\'option de recherche exacte'),
	('help_define_show_summary', '', 'Enable or disable the Summary tab found on the top right corner of the main window.', 'Définit si les sommaires (affichés dans le coin haut droit des formulaires) sont affichés ou non.'),
	('help_define_time_format', '', 'Select a 12 hour or 24 hour clock for time display.', 'Définit si les heures sont au format 12 ou 24 heures.'),
	('help_dose', '', 'Prescribed amount of the therapeutic agent administered', 'Quantité prescrite de l\'agent thérapeutique administré'),
	('help_drug_id', '', 'Generic name for the therapeutic agent administered.', 'Nom générique pour l\'agent thérapeutique administré'),
	('help_dx date', '', 'The date on which a patient is diagnosed with a particular condition or disease by most definitive method of diagnosis.', 'La date à laquelle le patient a été diagnostiqué avec une condition de santé particulière ou une maladie par les méthodes de diagnostic courantes'),
	('help_dx identifier', '', 'Unique identifier for each diagnosis in the system. Generated by the system at time of record creation.', 'Identifiant unique pour chaque diagnostic dans le système. Généré automatiquement par le système au moment de la création de l\'enregistrement.'),
	('help_dx method', '', 'Most definitive method by which the diagnosis of this tumour was established.', 'La méthode utilisée ayant permis d\'établir le diagnostic de la tumeur'),
	('help_dx nature', '', 'Indicates the nature of the disease coded in the registry abstract.', 'Indique la nature de la maladie telle que codifiée dans le résumé de registre'),
	('help_dx origin', '', 'Indicates whether the diagnosis is a primary, secondary (metastatic) or unknown tumour type.', 'Indique si le diagnostic du type tumoral est primaire, secondaire (métastatique) ou inconnu'),
	('help_effective date', '', 'Date the contact record became effective.', 'Date à laquelle l\'enregistrement du contact est entré en vigueur'),
	('help_expiry date', '', 'The date of service contact between a health service provider and patient/client has ended', 'La date du contact où le service entre le fournisseur de soins de santé et le patient/client s\'est terminé '),
	('help_facility', '', 'Building or place that provides a particular service or is used for a particular industry.', 'Bâtiment ou emplacement qui fournit un service particulier ou qui est utilisé pour une industrie particulière'),
	('help_family_domain', '', 'Defines how the participant is related to the family member.', 'Définit de quelle manière le participant est lié au membre de la famille'),
	('help_finish_date', '', 'Date on which the treatment was completed or ceased for the participant.', 'Date à laquelle le traitement a été complété ou a cessé pour le participant'),
	('help_first_name', '', 'The participant\'s identifying name within the family group or by which the person is socially identified.', 'L\'appellation du participant qui l\'identifie au sein de la même famille / du même groupe ou par laquelle la personne est socialement identifiée'),
	('help_flag_active', '', 'Determines whether the account can be used to log into ATiM or not. Locked means that the account cannot be used.', 'Détermine si le compte peut être utiliser pour se connecter à ATiM ou non. Bloqué signifie que le compte ne peut pas être utilisé.'),
	('help_flag_use_query_results', '', 'The system uses a custom query developped for your needs to look for displayed data. This feature could have an impact on the number of listed elements. If some records are not displayed, please convert your batch set to a generic batch set.', 'Le système utilise une requête personnalisée développée pour vos besoins afin de rechercher les données affichées. Cela pourrait avoir un impact sur ??le nombre d\'éléments affichés. Si certaines données ne sont pas affichées, veuillez convertir votre lot est un lot générique de données.'),
	('help_form_version', '', 'The version of the consent document in which the participant acknowledged participation by signing the document.', 'La version du formulaire de consentement dans lequel le participant a accepté de participer en signant le document'),
	('help_gravida', '', 'The number of times where a female conceived and became pregnant regardless of outcome.', 'Le nombre d\'occurrences où une femme a conçu ou est devenue enceinte, peu importe l\'aboutissement'),
	('help_hormonal contraceptive', '', 'Indicates whether the participant has used hormonal contraceptives in order to block ovulation and prevent the occurence of pregnancy.', 'Indique si le participant a utilisé des contraceptifs hormonaux dans le but de bloquer l\'ovulation et prévenir une occurrence de grossesse'),
	('help_hormone replacement', '', 'Indicator to represent a person\'s history of treatment with estrogens or estrogen/progesterone.', 'Indicateur représentant l\'historique de traitement d\'une personne aux oestrogènes ou oestrogène/progestérone'),
	('help_hrt years used', '', 'The category in total years that a female has taken hormone replacements.', 'Le nombre d\'années durant lesquelles la femme a pris des hormones de remplacement.'),
	('help_hysterectomy age', '', 'By a woman\'s recollection, the age the hysterectomy was performed expressed in number of years since birth.', 'Selon les souvenirs de la femme, l\'âge où l\'hystérectomie a été effectuée, en nombre d\'années depuis la naissance'),
	('help_hysterectomy indicator', '', 'Indicators whether or not the participant had a hysterectomy.', 'Indique si la participante a subi ou non une hystérectomie'),
	...
	('help_information_source', '', 'Defines the source of data for the current record.', 'Définit la source de l\'information pour l\'enregistrement présent'),
	('help_language preferred', '', 'The language (including sign language) most preferred by the person for communication.', 'La langue (incluant le language des signes) préféré par la personne pour communiquer'),
	('help_last chart checked', '', 'Date the participant\'s chart (electronic or paper file) was last checked for new or updated clinical information.', 'Date à laquelle la charte du participant (électronique ou en papier) a été vérifiée pour la dernière fois pour de la nouvelle information clinique ou pour une mise à jour'),
	('help_last_name', '', 'That part of a name a person usually has in common with some other members of his/her family, as distinguished from his/her given names.', 'L\'appellation du participant qu\'il a en commun avec d\'autres membres de sa famille'),
	('help_length_cycles', '', 'The number of days in each chemotherapy cycle.', 'Le nombre de jours de chaque cycle de chimiothérapie'),
	('help_lmnp date', '', 'By a women\'s recollection, the date she last had a menstrual period.', 'Au souvenir de la femme, la date à laquelle a eu lieu sa dernière période de menstruation'),
	('help_locality', '', 'City in which the contact resides.', 'Ville dans laquelle le contact réside'),
	('help_mail_code', '', 'Postal code corresponding to the client\'s address', 'Code postal correspondant à l\'adresse du client'),
	('help_marital status', '', 'A person\'s current relationship status in terms of a couple relationship or, for those not in a couple relationship, the existence of a current or previous registered marriage.', 'L\'état civil d\'une personne en terme de relation de couple, ou pour ceux qui ne sont pas en couple, l\'existence d\'un mariage actuel ou antérieur enregistré'),
	('help_memo', '', 'Text area for capturing generic comments.', 'Zone de texte pour la saisie des commentaires génériques'),
	('help_menopause reason', '', 'Explanation of why menstral periods ceased.', 'Raison expliquant pourquoi les périodes de menstruation ont cessé'),
	('help_menopause status', '', 'The menopausal status of the participant.', 'Le statut de la ménopause du participant'),
	('help_message_author', '', 'The author of document or digital message of correspondence.', 'L\'auteur du document ou message digital de correspondance'),
	('help_message_date_requested', '', 'The date on which a document or digital message was created.', 'Date à laquelle un document ou un message digital a été créé'),
	('help_message_description', '', 'A summary of a short communication transmitted by words, signals, or other means from one person, station or group to another.', 'Un sommaire d\'une courte communication transmise par mots, signaux ou autre manière pour une personne, une station, un groupe ou autre'),
	('help_message_due_date', '', 'The date on which a message or digital correspondence requests a response or an action completed.', 'La date à laquelle un message ou une correspondance électronique nécessite une réponse ou la complétion d\'une action'),
	('help_message_expiry_date', '', 'The date when a message no longer applies', 'Date à laquelle un message ne s\'applique plus'),
	('help_message_title', '', 'The title of a short written, or electronic piece of communication.', 'Le titre d\'une courte communication écrite ou électronique'),
	('help_message_type', '', 'Category, if applicable, for the digital message of correspondence.', 'Catégorie, si applicable, pour un message digital ou une correspondance'),
	('help_method', '', 'Primary method of administration for the prescribed therapeutic agent.', 'Méthode primaire d\'administration pour l\'agent thérapeutique prescrit.'),
	('help_middle_name', '', 'The middle name of the participant as listed on the patient record or report.', 'Le deuxième prénom d\'un participant tel que listé dans le dossier ou le rapport du patient'),
	('help_morphology', '', 'Records the type of cell that has become neoplastic and its biologic activity using ICD-O-3 codes.', 'Enregistre le type de cellules qui est devenue néoplasique ainsi que son activité biologique, utilisant les codes ICD-O-3'),
	('help_name_title', '', 'An honorific form of address, commencing a name, used when addressing a person by name, whether by mail, by phone, or in person, as represented by text.', 'Une forme honorifique de l\'adresse, à partir d\'un nom, utilisée pour s\'adresser à une personne par son nom, que ce soit par courriel, par téléphone ou en personne, telle que représentée par le texte.'),
	('help_notes', '', 'Text summary information used to add other relevant information for the current record.', 'Texte résumant l\'information utilisée afin d\'ajouter de l\'information supplémentaire pertinente pour l\'entrée en cours'),
	('help_num_cycles', '', 'The total numeric count of chemotherapy cycles ordered.', 'Le nombre total de cycles de chimiothérapie prescrits'),
	('help_operation_date', '', 'Date of the surgery being done of which materials for donation may be obtained.', 'Date de la chirurgie pour laquelle du matériel pourrait être obtenu pour la banque'),
	('help_ovary removed', '', 'Information related to the type of ovary that was removed.', 'Information liée au type d\'ovaire qui a été retiré'),
	('help_para', '', 'The total number of previous pregnancies the female participant has had resulting in live birth.', 'Le nombre total de grossesses précédentes qui ont eu pour résultat une naissance'),
	('help_participant identifier', '', 'Unique alphanumeric identifier used to uniquely identify the participant within ATiM. May be adopted from another system, generated or assigned.', 'Identifiant alphanumérique unique utilisé pour identifier les participants dans ATiM'),
	...
	('help_path_num', '', 'Alphanumeric indentifier corresponding to the pathology report generated from the participant\'s surgery.', 'Identifiant alphanumérique correspondant au rapport de pathologie généré à partir de la chirurgie du participant'),
	('help_path_stage_summary', '', 'The anatomical extent of disease by pathological classification based on the previously coded T, N and M stage categories, as represented by a code.', 'L\'étendue de la maladie au niveau anatomique de la classification pathologique basé sur les catégories de stade T, N et M, telle que représentée par un code'),
	('help_phone', '', 'A sequence of decimal digits (0-9) that is used for identifying a destination telephone line or other device in a telephone network from within the same city as the destination.', 'Une séquence numérique de chiffres (0-9) qui est utilisé pour identifier une destination téléphonique ou un autre appareil dans un réseau téléphonique à partir de la même ville que la destination'),
	('help_phone_secondary_type', '', 'Indicates the type of additional telephone contact number.', 'Indique le type des numéros de téléphone additionnels du contact'),
	('help_phone_type', '', 'Indicates the primary type of telephone contact number.', 'Indique le type du numéro de téléphone primaire du contact'),
	('help_previous primary code', '', 'Code representing the disease or condition according to an older, or alternative, disease coding system.', 'Code représentant la maladie ou la condition selon un système de codification de maladie plus vieux ou alternatif'),
	('help_previous primary code system', '', 'Previous, or alternative, coding system used to represent the disease or condition.', 'Système de codification précédent ou alternatif utilisé pour représenter la maladie ou la condition'),
	('help_previous_primary_code', '', 'The disease or condition code used prior to, or instead of, ICD-10.', 'La code de maladie/condition utilisé avant ou au lieu d\'ICD-10'),
	('help_previous_primary_code_system', '', 'The disease coding system used prior to, or instead of, ICD-10.', 'Le système de codification de maladie utilisé avant ou au lieu d\'ICD-10'),
	('help_primary code', '', 'The disease or condition as represented by an ICD-10 code.', 'La maladie ou la condition représentée par un code ICD-10'),
	('help_primary number', '', 'A counter indicating the number of primary malignant tumours a patient has had that are known by the bank.', 'Compteur indiquant le nombre de tumeurs primaires malignes qu\'un patient a eu et qui sont connues par la banque'),
	('help_primary_icd10_code', '', 'The disease or condition as represented by an ICD-10 code.', 'La maladie ou la condition représentée par un code ICD-10'),
	('help_process_status', '', 'Current step of the consent process.', 'Étape présente du processus de consentement'),
	('help_protocol_name', '', 'Name (or code) of treatment protocol that the participant was on.', 'Nom (ou code) du protocole de traitement sur lequel était le participant'),
	('help_race', '', 'The participant\'s self declared racial origination, independent of ethnic origination.', 'L\'origine raciale, telle que déclarée par le participant lui-même, indépendant de l\'origine ethnique'),
	('help_rad_completed', '', 'Indicates whether the radiotherapy treatment was completed.', 'Indique si le traitement de radiothérapie a été complété'),
	('help_reason_denied', '', 'Description of the reason(s) for participant denial or withdrawal of participation.', 'Description des raisons pour lesquelles le participant a refusé/retiré sa participation'),
	('help_region', '', 'Any demarcated area of the earth', 'N\'importe quelle zone démarquée de la Terre'),
	('help_relation', '', 'Type of relationship to the participant.', 'Type de relation du participant'),
	('help_response', '', 'The response of the tumour at the completion of the initial treatment modalities.', 'La réponse de la tumeur à la complétion des modalités de traitement initiales'),
	('help_route_of_referral', '', 'Indicates the entity (agency, person, etc) which introduced the participant to the biobanking program.', 'Indique l\'entité (agence, personne, etc.) qui a introduit le participant au programme de biobanque'),
	('help_secondary_cod_icd10_code', '', 'Any secondary disease, injury, circumstance of accident or violence which may have contributed to the person\'s death as represented by a code.', 'N\'importe quelle maladie secondaire, blessure, circonstance d\'accident ou violence qui peut avoir contribué à la mort de la personne, représenté par un code'),
	('help_sex', '', 'Sex is the biological distinction between male and female. Where there is an inconsistency between anatomical and chromosomal characteristics, sex is based on anatomical characteristics.', 'Le sexe est la distinction biologique entre un mâle et une femelle. Lorsqu\'il y a une inconsistance entre les caractéristiques anatomiques et chromosomiques, le sexe est basé sur les caractéristiques anatomiques'),
	('help_start_date', '', 'Date on which the treatment began for the participant.', 'Date à laquelle le traitement a commencé pour le participant'),
	('help_status_date', '', 'Date on which the Consent Status field was last updated in the system.', 'Date à laquelle le champ du statut du consentement a été mis à jour pour la dernière fois dans le système'),
	('help_storage_layout_remove', '', 'Items in this cell will be removed from the storage.', 'Les items dans cette cellule seront retirés de l\'entreposage.'),
	('help_storage_layout_storage', '', 'The cells above are a representation of the positions of the storage.', 'Les cellules ci-dessous sont une représentation des positions de votre entrposage.'),
	('help_storage_layout_unclassified', '', 'Items in this cell are in the storage but do not have a position.', 'Les items dans cette cellule font partie de l\'entreposage mais n\'ont pas de position d\'assignée.'),
	('help_street', '', 'Street address/post office box number/rural route number, group number.', 'Adresse civique/numéro de boite postale/numéro de route rurale, numéro de groupe'),
	('help_surgeon', '', 'Name of the surgeon performing the surgery where materials for donation may be obtained.', 'Nom du chirurgien qui a effectué la chirurgie où les matériaux pour le don peuvent avoir été obtenues'),
	('help_surgical_procedure', '', 'Name or code of the surgical operation performed on the day of treatment.', 'Nom ou code d\'opération chirurgicale effectuée le jour du traitement'),
	('help_survival time', '', 'Length of time in months the participant has survived since the original date of diagnosis.', 'Durée de temps en mois de la survie du participant depuis la date originale du diagnostic'),
	('help_target_site_icdo', '', 'The site or region of cancer which is the target of a particular treatment, as represented by an ICDO-3 code.', 'Le site ou la région du cancer qui est la cible d\'un traitement particulier, représenté par un code ICDO-3'),
	('help_topography', '', 'The topography code indicates the site of origin of a neoplasm.', 'Le code de topographie indique le site de l\'origine d\'un néoplasme'),
	('help_translator_indicator', '', 'Indicates whether a translator, legally acceptable representative or impartial witness was used.', 'Indique si un traducteur, un représentant légalement acceptable ou un témoin impartial a été utilisé'),
	('help_translator_signature', '', 'Indicates whether a signature was obtained from a translator, legally acceptable representative or impartial witness.', 'Indique si une signature a été obtenue du traducteur, du représentant légalement acceptable ou du témoin impartial'),
	('help_tumour grade', '', 'Code to represent the grade or differentiation of the tumour.', 'Code pour représenter le grade ou la différentiation de la tumeur'),
	('help_tx_intent', '', 'The intention of the treatment for cancer for the particular participant.', 'L\'intention de traitement pour un cancer pour un participant en particulier'),
	('help_tx_method', '', 'The type of treatment given to the participant.', 'Le type de traitement donné au participant'),
	('help_vital status', '', 'The state or condition of being living or deceased.', 'Définit si le patient est décédé ou vivant.'),
	('help_years on hormonal', '', 'Represents the cumulative number of years that hormonal contraceptives were used by the individual.', 'Représente le nombre cumulé d\'années durant lesquelles des contraceptifs hormonaux ont été utilisés par l\'individu'),
	...
	('if no lab book has to be defined for this process, keep fields empty and click submit to continue', '', 'If no lab book has to be defined for this process, keep fields empty and click submit to continue.', 'Si aucun cahier de laboratoire ne doit être défini pour ce processus, gader les champs vide et cliquer sur \'Envoyer\'.'),
	...
	('information about the diagnosis module is available %s here', '', 'Information about the diagnosis module is available <a href=\'%s\' target=\'blank\'>here</a>.', 'L\'information à propos du module de diagnostic est disponible <a href=\'%s\' target=\'blank\'>ici</a>. (Anglais)'),
	...
	('initiated from batchset', '', 'Browsing initiated from batchset', 'navigation initiée d\'un lot de données'),
	('initiated from report', '', 'Browsing initiated from report', 'navigation initiée d\'un rapport'),
	...
	('inv_collection_datetime_defintion', '', 'Date of the specimen collection (surgery date, biopsy date, urine collection date, etc).', 'Date du prélèvement du spécimen (ex: date de la chirurgie, date de la biopsie, date de la collection d\'urine, etc).'),
	...
	('inv_coll_to_creation_spent_time_msg_defintion', '', 'Elapsed time between the date of the specimen collection (surgery date, biopsy date, urine collection date, etc) and the date of the process that allowed to obtain the derivative (DNA extraction, blood centrifugation, protein extraction, RNA amplification, etc).', 'Temps écoulé entre la date du prélèvement du specimen (date de la chirurgie, la date biopsie, date du prélèvement d\'urine, etc) et la date du processus qui a permis d\'obtenir le dérivé (extraction d\'ADN, centrifugation du sang, extraction des protéines, amplification d\'ARN, etc).'),
	('inv_coll_to_rec_spent_time_msg_defintion', '', 'Elapsed time between the date of the specimen collection (surgery date, biopsy date, urine collection date, etc) and the date of the specimen reception into the bank/lab (the specimen is physically present into the bank or a lab people just take possession of the sample).', 'Temps écoulé entre la date du prélèvement du specimen (date de la chirurgie, la date biopsie, date du prélèvement d\'urine, etc) et la date de réception du spécimen dans la banque/laboratoire (l\'échantillon est physiquement présent dans la banque ou une personne du laboratoire vient de prendre possession de l\'échantillon).'),
	('inv_coll_to_stor_spent_time_msg_defintion', '', 'Elapsed time between the date of the specimen collection (surgery date, biopsy date, urine collection date, etc) and the date the aliquot (tube, block, etc) has been stored (into a freezer, fridge, nitrogen container, etc) for the first time.', 'Temps écoulé entre la date du prélèvement du spécimen (ex: date de la chirurgie, date de la biopsie, date de la collection d\'urine, etc) la date à laquelle l\'aliquot (tube, bloc, etc) a été entreposé (dans un congélateur, un réfrigérateur, un conteneur d\'azote, etc) pour la première fois.'),
	('inv_creation_datetime_defintion', '', 'Date of the process that allowed to obtain the derivative from a parent sample (DNA extraction, blood centrifugation, protein extraction, RNA amplification, etc).', 'Date du processus qui a permis d\'obtenir l\'échantillon dérivé à partir d\'un échantillon parent (extraction d\'ADN, centrifugation de sang, extraction de protéines, amplification d\'ARN, etc).'),
	('inv_creat_to_stor_spent_time_msg_defintion', '', 'Elapsed time between the date of the process that allowed to obtain the derivative from a parent sample (DNA extraction, blood centrifugation, protein extraction, RNA amplification, etc) and the date the aliquot (tube, block, etc) has been stored (into a freezer, fridge, nitrogen container, etc) for the first time.', 'Temps écoulé entre la date du processus qui a permis d\'obtenir l\'échantillon dérivé à partir d\'un échantillon parent (extraction d\'ADN, centrifugation de sang, extraction de protéines, amplification d\'ARN, etc) et la date à laquelle l\'aliquot (tube, bloc, etc) a été entreposé (dans un congélateur, un réfrigérateur, un conteneur d\'azote, etc) pour la première fois.'),
	('inv_initial_storage_datetime_defintion', '', 'Date the aliquot (tube, block, etc) has been stored (into a freezer, fridge, nitrogen container, etc) for the first time whatever happens in the futur for this aliquot (aliquot move, use, etc).', 'Date à laquelle l\'aliquot (tube, bloc, etc) a été entreposé (dans un congélateur, un réfrigérateur, un conteneur d\'azote, etc) pour la première fois, quoi qu\'il arrive à cet aliquot dans le futur (déplacemement de l\'aliquot, utilisation, etc.)'),
	...
	('inv_pathology_reception_datetime_defintion', '', 'Date a specimen has been received in the department of pathology just before the lab people take possession of this specimen (ex: when the specimen is delivered to the lab people by the pathology departmement).', 'Date à laquelle un spécimen a été reçu dans le département de pathologie juste avant que les personnes du laboratoire prennent possession de ce spécimen (ex: lorsque l\'échantillon est délivré aux personnes laboratoire par le departmement pathologie).'),
	('inv_quality_control_date_defintion', '', 'Date a sample and/or an aliquot has been tested to define the quality, the concentration, etc.', 'Date à laquelle un échantillon et /ou un aliquot a été testé pour évaluer la qualité, la concentration, etc.'),
	('inv_realiquoting_datetime_defintion', '', 'Date an aliquot of a sample has been realiquoted to create one or many aliquots of this sample from the this aliquot source (ex: DNA tube creation from a stored DNA tube for shipping, tissue block creation from tissue tube, etc).', 'Date à laquelle l\'aliquot d\'un échantillon a été realiquoté afin de créer un ou plusieurs aliquots de ce même échantillon à partir de l\'aliquot source (ex: création d\'un tube d\'ADN à partir d\'un autre tube d\'ADN entreposé pour une expédition, la création d\'un bloc de tissu à partir d\'un tube de tissu, etc).'),
	...
	('inv_reception_datetime_defintion', '', 'Date of the specimen reception into the bank/lab (the specimen is physically present into the bank or a lab people just take possession of the sample).', 'Date de réception du spécimen dans la banque/laboratoire (l\'échantillon est physiquement présent dans la banque ou une personne du laboratoire vient de prendre possession de l\'échantillon).'),
	('inv_rec_to_stor_spent_time_msg_defintion', '', 'Elapsed time between the date of the specimen reception into the bank/lab (the specimen is physically present into the bank or a lab people just take possession of the sample) and the date the aliquot (tube, block, etc) has been stored (into a freezer, fridge, nitrogen container, etc) for the first time.', 'Temps écoulé entre la date de réception du spécimen dans la banque/laboratoire (l\'échantillon est physiquement présent dans la banque ou une personne du laboratoire vient de prendre possession de l\'échantillon) et la date à laquelle l\'aliquot (tube, bloc, etc) a été entreposé (dans un congélateur, un réfrigérateur, un conteneur d\'azote, etc) pour la première fois.'),
	...
	('inv_use_datetime_defintion', '', 'Date an aliquot has been used (quality control, realiquoting, internal use (loan to another lab, etc), order, etc).', 'Date à laquelle un aliquot a été utilisé (contrôle de la qualité, \'realiquotage\', usage interne (prêt à un autre laboratoire, etc), commande, etc).'),
	...
	('July', '', 'July', 'Juillet'),
	('jun', '', 'Jun', 'Jun'),
	('junction of right and left hepatic ducts', '', 'Junction of Right and Left Hepatic Ducts', ''),
	('June', '', 'June', 'Juin'),
	('keep entries with the most recent date per participant', '', 'Keep entries with the most recent date per participant', 'Conserver les entrées avec la date la plus récente par participant'),
	('keep entries with the most recent start date per participant', '', 'Keep entries with the most recent start date per participant', 'Conserver les entrées avec la date de départ la plus récente par participant'),
	('keep entries with the oldest date per participant', '', 'Keep entries with the oldest date per participant', 'Conserver les entrées avec la  date la plus ancienne par participant'),
	('keep entries with the oldest start date per participant', '', 'Keep entries with the oldest start date per participant', 'Conserver les entrées avec la date de départ la plus ancienne par participant'),
	('keep synchronized with lab book', '', 'Keep Synchronized', 'Garder Synchronisé'),
	('keep the \'new value\' field empty to not change data and use the \'erase/remove\' checkbox to erase the data', '', 'Keep the \'New Value\' field empty to not change data and use the \'Erase/Remove\' checkbox to erase the data.', 'Garder le champ \'nouvelle valeur\' vide pour ne pas modifier les données et utilisez la case \'Éffacer/Enlever \'pour effacer les données.'),
	...
	('lab book description', '', 'Allows to track data linked to a set of inventory entities created during a batch process (realiquoting, derivatives creation, etc) and that can be applied to the all. This tool can be used to synchronize all data of these entities created in batch.', 'Permet l\'enregistrement de données liées à des entités de l\'inventaire créés durant le même processus (realiquotiage en lot, dérivés créés en lot, etc) et qui s\'appliquent à l\'ensemble des entités. Cette outil peut être utilisé pour synchroniser les données de ces entités créés en lot.'),
	...
	('link to databrowser wiki page %s  + datamart structures relationship diagram access', '', 'The DataBrowser is a tool that allows you to browse from one data type to another through various search forms.<br>More information about databrowser is available <a href="%s" target="blank">here</a>.<br>By default, the system will use the shortest way to browse from one data type to another.<br>Be sure an appropriate way has been used checking the following document: ', 'Le Navigateur de données est un outil qui vous permet de naviguer d\'un type de données à un autre à travers différents formulaires de recherche.<br>Plus d\'informations sur le Navigateur de données sont disponibles <a href="%s" target="blank">ici</a>.<br>Par défaut, le système utilisera le chemin le plus court pour aller d\'un type de données à un autre.<br>Assurez-vous qu\'un chemin approprié a été utilisé en vous basant sur le diagramme suivant: '),
	('linked collection', '', 'Linked Collection', 'Collection liée'),
	('links between storage and tma slides are limited to tma blocks and slides created from these blocks - different than slide storage', '', 'Links between storage and TMA slides are limited to TMA blocks and slides created from these blocks. The databrowser won\'t link TMA slide to the storage containing these slides.', 'Les liens entre les entreposages et les lames de TMA sont limitès aux blocs de TMA et aux lames créées à partir de ces blocs. Le \'Navigateur de Données\' ne fait pas le lien entre les lames de TMA et les entreposages contenant les lames.'),
	('links to collections', '', 'Links to collections', 'Liens à des collections'),
	('links were not copied since the destination is an independant collection', '', 'Links were not copied since the destination is an independant collection.', 'Les liens n\'ont pas été copiés puisque la destination est une collection indépendante.'),
	('list', '', 'List', 'Liste'),
	...
	('login_help', '', 'Enter your username and password to access ATiM. Please contact your system administrator if you have forgotten your login credentials.', 'Entrez votre nom d\'utilisateur et votre mot de passe pour accéder à ATiM. En cas d\'oubli, contactez l\'administrateur d\'ATiM.'),
	...
	('magins pancreaticoduodenal resection specimen', '', 'Magins : Pancreaticoduodenal Resection Specimen', ''),
	('mail', '', 'Mail', 'Courriel'),
	...
	('margins', '', 'Margins', ''),
	('margins : other', '', 'Margins : Other', ''),
	('margins : pancreaticoduodenal resection specimen', '', 'Margins : Pancreaticoduodenal Resection Specimen', ''),
	('margins : segmental resection or pancreaticoduodenectomy', '', 'Margins : Segmental Resection or Pancreaticoduodenectomy', ''),
	('margins : segmental resection specimen', '', 'Margins : segmental Resection Specimen', ''),
	('margins ampullectomy specimen', '', 'Margins : Ampullectomy Specimen', ''),
	('margins involved by carcinoma in situ', '', 'Margins involved by carcinoma in situ', ''),
	('margins involved by invasive carcinoma', '', 'Margins Involved By Invasive Carcinoma', ''),
	('margins uninvolved by carcinoma in situ', '', 'Margins uninvolved by carcinoma in situ', ''),
	('margins uninvolved by invasive carcinoma', '', 'Margins Uninvolved By Invasive Carcinoma', ''),
	...
	('matching_participant_number_help', '', 'Number of participants of the samples included into the count of the previous column.', 'Nombre de participants des échantillons inclus dans le décompte de la colonne précédente.'),
	...
	('merge_coll_desc', '', 'The collection from which the content will be merged. After the operation that collection will be deleted.', 'La collection dont le contenu sera déplacé. Après l\'opération la collection sera supprimée.'),
	('merge_coll_into_desc', '', 'The collection into which the content will be merged.', 'La collection dans laquelle le contenu sera fusionné.'),
	('merge_confirmation_msg', '', 'Merge actions cannot be undone. Do you want to continue?', 'Les fusions ne peuvent pas être annulées. Souhaitez-vous continuer?'),
	('merge_part_desc', '', 'The participant from which the sub forms information is transfered. No profile information is transfered. Identifiers are merged when non conflicting. The participant is not deleted automaticaly after the process to allow an identifiers review.', 'Le participant à partir duquel l\'information des sous formulaires sera transférée. Aucune information de profil n\'est transférée. Les identifiants non conflictuels sont fusionés. Le participant n\'est pas automatiquement supprimé pour permettre la validation des identifiants.'),
	...
	('microscopic tumor extension', '', 'Microscopic Tumor Extension', 'Extension de tumeur miscroscopique'),
	...
	('misc_identifier_reuse', '', 'Deleted identifiers can be reused. Do you want to create a <u>new</u> identifier or select one to <u>reuse</u>?', 'Des identifiants peuvent être réutilisés Souhaitez-vous en créer un <u>nouveau</u> ou en choisir un à <u>réutiliser</u>?'),
	('miss', '', 'Miss', 'Mlle'),
	...
	('mitotic activity', '', 'Mitotic Activity', 'Activité mitotique'),
	...
	('month_unit', '', 'm', 'm'),
	('more information about the types of samples and aliquots are available %s here', '', 'Information about the types of samples and aliquots is available <a href=\'%s\' target=\'blank\'>here</a>.', 'L\'information sur les types d\'échantillons et d\'aliquots est disponible <a href=\'%s\' target=\'blank\'>ici</a>.'),
	...
	('mould', '', 'Mould', 'Moule'),
	('move storage content', '', 'Move Storage Contents', 'Déplacer contenu entreposage'),
	...
	('mucosal lateral margin', '', 'Mucosal Lateral Margin', ''),
	('mucosal/Lateral margin', '', 'Mucosal/Lateral Margin', ''),
	...
	('multi_entry_form_confirmation_msg', '', 'You are about to submit a form with multiple entries. Do you want to continue?', 'Vous êtes sur le point de soumettre un formulaire contenant des entrées multiples. Souhaitez-vous continuer?'),
	...
	('new_collections_nbr_help', '', 'Number of participants linked to at least one collection with a collection date included into the defined period.', 'Nombre de participants liés à au moins une collection ayant une date de collection inclue dans la période définie.'),
	('new_participants_nbr_help', '', 'Number of participants created into the system during the defined period (based on the dates of the participants creation into the system).', 'Nombre de participants créés dans le système pendant la période définie (selon les dates de création des patients dans le système).'),
	('next', '', 'Next', 'Suivant'),
	('ng/ul', '', 'ng/ul', 'ng/ul'),
	('niece', '', 'Niece', 'Nièce'),
	...
	('no aliquot has been defined as sample tested aliquot', '', 'No aliquot has been defined as sample tested aliquot', 'Aucun aliquot de l\'échantillon n\'a été défini comme testé'),
	...
	('no consent is linked to the current participant collection', '', 'No consent is linked to the current participant collection', 'Aucun consentement n\'est lié à la présente collection de participant'),
	...
	('no data matches your search parameters', '', 'No data matches your search parameters!<br><br><i>Note the system used the shortest way to browse from the previous data type to the selected one. Be sure no other appropriate way exists to browse your data checking the \'Data Types Relationship Diagram\'.</i>', 'Aucune données ne correspond à vos critères de recherche!<br><br><i>Notez que le système à utilisé le chemin le plus court pour aller du précédant type de données à celui sélectionné. Assurez-vous qu\'aucun autre chemin plus approprié ne peut être utilisé en vous basant sur le \'Diagramme des realtions des types de données\'.</i>'),
	...
	('no participant is linked to the current participant collection', '', 'No participant is linked to the current participant collection.', 'Aucun participant n\'est lié à la présente collection de participant.'),
	...
	('no search criteria', '', 'No search criteria', 'Aucun critères de recherche'),
	...
	('not done participant messages having reached their due date', '', 'Not done participant message(s) having reached their due date.', 'Message(s) des participants pas faits ayant atteint leur date d\'échéance.'),
	...
	('number of values used as input', '', 'Number of values used as input', 'Nombre de valeurs utilisées comme entrée'),
	...
	('number_of_elements_per_participant_description', '', 'Count the number of elements displayed in the previous list (Batchset, Databrowser Node) grouped by participant', 'Compte le nombre d\'éléments affichés dans la liste précédente (lot de données, Noeud du \'Navigateur de Données\') par participant'),
	('nunavut', '', 'Nunavut', 'Nunavut'),
	('obesity', '', 'Obesity', ''),
	('obtained', '', 'Obtained', 'Obtenu'),
	('obtained consents', '', 'Obtained Consents', ''),
	('obtained_consents_nbr_help', '', 'Number of consents having a signature date included into the defined period.', 'Nombre de consentements ayant une date de signature inclue dans la période définie.'),
	('oct', '', 'Oct', 'Oct'),
	('oct solution', '', 'OCT', 'OCT'),
	('October', '', 'October', 'Octobre'),
	('ok', '', 'Ok', 'Ok'),
	('old password', '', 'Old Password', 'Ancien mot de pass'),
	...
	('or erase data', '', 'Or Erase Data', 'Ou effacer les données'),
	...
	('order lines', '', 'Order lines', 'Lignes de commande'),
	...
	('other organ received', '', 'Other Organ Received', ''),
	...
	('pancreatic retroperitoneal margin', '', 'Pancreatic Retroperitoneal Margin', ''),
	('pancreatic tail', '', 'Pancreatic Tail', ''),
	('pancreaticoduodenal resection specimen', '', 'Pancreaticoduodenal Resection Specimen', ''),
	...
	('parent aliquot data update', '', 'Parent Aliquot Data For Update', 'Données aliquot parent pour mise à jour '),
	...
	('passwords minimal length', '', 'Passwords must have a minimal length of 6 characters', 'Les mots de passe doivent avoir une longueur minimale de 6 caractères'),
	...
	('password_format_error_msg_2', '', 'Passwords must have a minimum length of 8 characters and contain uppercase letters, lowercase letters and numbers.', 'Les mots de passe doivent avoir une longueur minimale de 8 caractères et être composés de lettres majuscules, de lettres minuscules et de chiffres.'),
	('password_format_error_msg_3', '', 'Passwords must have a minimum length of 8 characters and contain uppercase letters, lowercase letters, numbers and special characters.', 'Les mots de passe doivent avoir une longueur minimale de 8 caractères et être composés de lettres majuscules, de lettres minuscules, de chiffres et de caractères spéciaux.'),
	('paste', '', 'Paste', 'Coller'),
	...
	('pcr', '', 'PCR', 'PCR'),
	('pedunculated with stalk', '', 'Pedunculated With Stalk', ''),
	...
	('permissible_values_custom_use_as_input', '', 'If checked, the value can be used as input. If not, the value can only be used for search and data look ups.', 'Si sélectionné, la valeur peut être utilisée comme entrée. Sinon, la valeur peut seulement être utilisée pour les recherches et pour le pairage des données.'),
	...
	('permissions were altered to grant group administrators all administrative privileges', '', 'Permissions were altered to grant group "Administrators" all administrative privileges.', 'Les permissions ont été altérées pour que le groupe des "Administrators" ait tous les privilèges d\'administration.'),
	...
	('please check following barcodes', '', 'Please check following barcodes: ', 'Veuillez contrôler les code à barres suivants:'),
	...
	('polyp configuration', '', 'Polyp Configuration', ''),
	('polyp size', '', 'Polyp Size', ''),
	('polyp size greatest dimension', '', 'Polyp Size Greatest Dimension (cm)', ''),
	('polyp_size_greatest_dimension (cm)', '', 'Polyp Size Greatest Dimension (cm)', ''),
	('poor', '', 'Poor', 'Pauvre'),
	...
	('proximal bile duct margin', '', 'Proximal Bile Duct Margin', ''),
	('proximal margin', '', 'Proximal Margin', ''),
	('proximal mucosal margin', '', 'Proximal Mucosal Margin', ''),
	('proximal pancreatic margin', '', 'Proximal Pancreatic Margin', ''),
	('PSC', '', 'PSC', ''),
	...
	('quality control data exists for the deleted aliquot', '', 'Your data cannot be deleted! <br>Quality control data exists for the deleted aliquot.', 'Vos données ne peuvent être supprimées! <br>Des données de contrôle de qualité existent pour votre aliquot.'),
	...
	('query tool dadhoc description', '', 'Custom queries used for searching specific data based on predefined criteria.', 'Requêtes personnalisées utilisées pour rechercher des données spécifiques sur la base de critères prédéfinis.'),
	('query tool data browser description', '', 'Flexible tool used for running specific data research. The process enables the user to browse sequentially different data search forms.', 'Outil flexible utilisé pour exécuter des recherches spécifiques de données. Le processus de navigation permet à l\'utilisateur de parcourir successivement différents formulaires de recherche de données.'),
	...
	('query tool reports description', '', 'Reports generated from recorded data.', 'Rapports construits à partir des données enregistrées.'),
	('quiescent', '', 'Quiescent', ''),
	('race', '', 'Race', 'Race'),
	...
	('rebuilt lft rght for storage_masters', '', 'Rebuilt lft & rght for storage_masters', 'Les valeurs lft & rght de storage_masters ont été regénérées'),
	...
	('records linked to study', '', 'Records linked to study', 'Données attachées à l\'étude'),
	...
	('report_3_name', '', 'Bank Activity Report', 'Rapport d\'activité'),
	...
	('report_5_name', '', 'Bank Activity Report (Per Period)', 'Rapport d\'activité (Par période)'),
	...
	('sample_code_help', '', 'Unique code generated by the system.', 'Code unique généré par le système.'),
	...
	('saved browsing description', '', 'Steps', 'Étapes'),
	...
	('search start from', '', 'Search Start From', 'Recherche a partir de'),
	...
	('security control', '', 'Security Control', 'Contrôle de sécurité'),
	('see # %s', '', 'See # %s!', 'Voir # %s!'),
	...
	('select an identifier to assign to the current participant', '', 'Select an identifier to assign to the current participant.', 'Sélectionner un identifiant à assigner au participant actuel.'),
	...
	('select the identifiers you wish to delete permanently', '', 'Select the identifiers you wish to delete permanently', 'Sélectionnez les identifiants que vous souhaitez supprimer de façon permanente'),
	...
	('serum', '', 'Serum', 'Sérum'),
	('server_client_time_discrepency', '', 'There is a time discrapency between the server and your computer. Verify that your computer time and date are accurate. It they are, contact the administrator.', 'Il y a un écart entre l\'heure et la date de votre serveur et de votre ordinateur. Vérifiez que votre heure et votre date sont correctement définis. S\'ils le sont, contactez l\'administrateur.'),
	('sessile', '', 'Sessile', ''),
	('sessile serrated adenoma', '', 'Sessile serrated adenoma', ''),
	('set temperature', '', 'Set temperature', 'Definir temprature'),
	('sex', '', 'Sex', 'Sexe'),
	('share set with group', '', 'Share Set With Group', 'Ensembles de données accessible au groupe'),
	...
	('size of invasive carcinoma', '', 'Size of Invasive Carcinoma', ''),
	('skin', '', 'Skin', 'Peau'),
	...
	('some identifiers were not merge because they were conflicting', '', 'Some identifiers were not merge because they were conflicting.', 'Certains identifiants n\'ont pas été fusionnés car ils étaient conflictuels.'),
	('son', '', 'Son', 'Fils'),
	('sop', '', 'SOP', 'SOP'),
	...
	('specimen integrity', '', 'Specimen Integrity', ''),
	...
	('stalk length cm', '', 'Stalk Length (cm)', ''),
	...
	('storage code', '', 'Storage System Code', 'Entreposage - Code système'),
	...
	('storage content tree view', '', 'Content (Tree View)', 'Contenu (Vue hiérarc.)'),
	...
	('storages without layout have been removed from the results', '', 'Storages without layout have been removed from the results', 'Les entreposages sans disposition ont été retirés des résultats'),
	('storage_code_help', '', 'Unique code generated by the system.', 'Code unique généré par le système.'),
	...
	('STR_NAVIGATE_UNSAVED_DATA', '', 'You have unsaved modifications. Are you sure you want to leave this page?', 'Vous avez des modifications non enregistrées. Êtes-vous certain de vouloir quitter cette page?'),
	('studied aliquots', '', 'Studied Alquots', 'Aliquots sélectionnés'),
	('study', '', 'Study', 'Étude'),
	('study / project', '', 'Study/Project', 'Étude/Projet'),
	('study and project', '', 'Study & Project', 'Étude & Projet'),
	('study end', '', 'Study End', 'Fin de l\'Étude'),
	('study start', '', 'Study Start', 'Début de l\'Étude'),
	('study/project is assigned to a  tma slide', '', 'Your data cannot be deleted! This study/project is linked to a TMA slide. ', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à un lame de TMA. '),
	('study/project is assigned to a consent', '', 'Your data cannot be deleted! This study/project is linked to a consent. ', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à un consentement. '),
	('study/project is assigned to a participant', '', 'Your data cannot be deleted! This study/project is linked to a participant. ', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à un patient. '),
	('study/project is assigned to an aliquot', '', 'Your data cannot be deleted! This study/project is linked to aliquot creation.', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à une création d\'aliquot.'),
	('study/project is assigned to an order', '', 'Your data cannot be deleted! This study/project is linked to an order.', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à une commande.'),
	('study/project is assigned to an order line', '', 'Your data cannot be deleted! This study/project is linked to an order line.', 'Vos données ne peuvent être supprimées! Ce(tte) étude/projet est attaché(e) à une ligne de commande.'),
	('study_$', '', '$', '$'),
	...
	('the current diagnosis date is before the parent diagnosis date', '', 'The current diagnosis date is before the parent diagnosis date.', 'L\'actuelle date de diagnostic est avant la date du diagnostic parent.'),
	...
	('the diagnosis value for %s does not match the cap report value', '', 'The diagnosis value for %s does not match the cap report value', 'La valeur du diagnostic pour %s ne correspond pas à la valeur du rapport cap'),
	...
	('the group administrators cannot be deleted', '', 'The group "Administrators" cannot be deleted.', 'Le groups "Administrators" ne peut pas être supprimé.'),
	('the group administrators cannot be edited', '', 'The group "Administrators" cannot be edited.', 'Le groups "Administrators" ne peut pas être modifié.'),
	...
	('the results contain various data types, so the details are not displayed', '', 'The results contain various data types, so the details are not displayed.', 'Les résultats contiennent différents types de données, alors les détails ne sont pas affichés.'),
	('the selected lab book cannot be applied to the current item(s)', '', 'The selected lab book cannot be applied to the current item(s)!', 'Le cahier de laboratoire sélectionné ne peut être appliqué à ces données!'),
	...
	('the storage you are already working on has been removed from the results', '', 'The storage you are already working on has been removed from the results', 'L\'entreposage sur lequel vous travaillez a été retiré des résultats'),
	('the storage [%s] already contained something at position [%s, %s]', '', 'The storage [%s] already contained something at position [%s, %s]', 'L\'entreposage [%s] contenait déjà quelque chose à la position [%s, %s]'),
	('the string length must not exceed %d characters', '', 'The string length must not exceed %d characters!', 'La longueur de la chaîne de caractères ne doit pas dépasser %d caractères!'),
	...
	('there are no unused identifiers left to reuse. hit cancel to return to the identifiers list.', '', 'There are no unused identifiers left to reuse. Hit cancel to return to the identifiers list.', 'Il n\'y a plus d\'identifiants non utilisés. Appuyez sur annuler pour retourner à la liste des identifiants.'),
	('there are no unused identifiers of the current type', '', 'There are no unused identifiers of the current type.', 'Il n\'y a pas d\'identifiants du type actuel non utilisés.'),
	('there are no unused parent items', '', 'There are no unused parent items', 'Il n\'y a pas d\'éléments parents non utilisés'),
	('there are too many main storages for display', '', 'There are too many \'main\' storages for display', 'Il existe trop d\'entreposages principaux pour l\'affichage'),
	...
	('this is not a time', '', 'Data entered is not a valid time', 'La donnée saisie n\'est pas un temps'),
	...
	('this list contains aliquot(s) without a proper consent', '', 'This list contains aliquot(s) without a proper consent', 'Cette liste contient un ou des aliquots sans consentement approprié'),
	...
	('time_at_room_temp_mn_help', '', 'Elapsed time (minutes) between the collection time and the first time the specimen has been stored at low temperature (Ex: Elapsed time between blood sampling and blood storage by the nurse in a fridge before the lab people take possession of the tubes).', 'Temps écoulé (en minutes) entre l\'heure de collection et l\'heure ou les spécimens ont été placés à basse température (ex: temps écoulé entre le prélèvement de sang et le stockage du sang par l\'infirmière dans un réfrigérateur avant que les personnes du laboratoire prennent possession des tubes).'),
	...
	('to see all elements, convert your batchset using the generic batch set options', '', 'To see all elements, convert your batchset using the generic batch set options.', 'Pour visualiser tous les éléments, convertissez votre lot de données en utilisant les options de \'Lot générique de données\'.'),
	('to synchronize with a lab book, you need to define a lab book to use', '', 'To synchronize with a lab book, you need to define a lab book to use!', 'Pour synchroniser avec un cahier de laboratoire, vous devez en définir un!'),
	('Tool', '', 'Tool', 'Outil'),
	...
	('trying to put storage [%s] within itself failed', '', 'Trying to put storage [%s] within itself failed', 'La tentative de mettre l\'entreposage [%s] à l\'intérieur de lui-même a échouée.'),
	('tube', '', 'Tube', 'Tube'),
	...
	('tumor confined to the bile duct histologically', '', 'Tumor Confined to The Bile Duct Histologically', ''),
	...
	('tumor invades beyond the wall of the bile duct', '', 'Tumor Invades Beyond The Wall of The Bile Duct', ''),
	...
	('tumor invades duodenal wall', '', 'Tumor Invades Duodenal Wall', ''),
	('tumor invades extrapancreatic common bile duct', '', 'Tumor Invades Extrapancreatic Common Bile Duct', ''),
	...
	('tumor invades other adjacent organ or structures', '', 'Tumor Invades Other Adjacent Organ Or Structures', ''),
	('tumor invades other adjacent organs or structures', '', 'Tumor invades other adjacent organs or structures', ''),
	('tumor invades other adjacent structures', '', 'Tumor Invades Other Adjacent Structures', ''),
	('tumor invades other peripancreatic soft tissue', '', 'Tumor invades other peripancreatic soft tissue', ''),
	('tumor invades pancreas', '', 'Tumor Invades Pancreas', ''),
	...
	('tumor invades peripancreatic soft tissues', '', 'Tumor Invades Peripancreatic Soft Tissues', ''),
	...
	('tumor invades the duodenum', '', 'Tumor Invades The Duodenum', ''),
	('tumor invades the gallbladder', '', 'Tumor Invades The Gallbladder', ''),
	('tumor invades the pancreas', '', 'Tumor Invades The Pancreas', ''),
	...
	('tumor limited to ampulla of vater or sphincter of oddi', '', 'Tumor Limited To Ampulla Of Vater Or sphincter Of Oddi', ''),
	...
	('type of polyp in which invasive carcinoma arose', '', 'Type of Polyp In Which Invasive Carcinoma Arose', ''),
	('ug/ul', '', 'ug/ul', 'ug/ul'),
	('ul', '', 'ul', 'ul'),
	...
	('undetailed', '', 'Undetailed', 'non détaillée'),
	...
	('unsaved batch sets that are automatically deleted when there are more than %d', '', 'Unsaved batch sets that are automatically deleted when there are more than %d.', 'Lots de données non enregistrés qui sont supprimés automatiquement lorsqu\'il y en a plus de %d.'),
	('unsaved browsing trees that are automatically deleted when there are more than %d', '', 'Unsaved browsing trees that are automatically deleted when there are more than %d.', 'Arbres de navigation non enregistrés qui sont supprimés automatiquement lorsqu\'il y en a plus de %d.'),
	('unsaved browsing trees that are automatically deleted when there are more than x', '', 'Unsaved browsing trees that are automatically deleted when there are more than 5.', 'Arbres de navigation non enregistrés qui sont supprimés automatiquement lorsqu\'il y en a plus de 5.'),
	...
	('use counter', '', 'Uses/Events', 'Utilisations/Événements'),
	...
	('use/event creation', '', 'Use/Event Creation', 'Création utilisation/événement'),
	('used', '', 'Used', 'Utilisé'),
	...
	('when defining a temperature, the temperature unit is required', '', 'When defining a temperature, the temperature unit is required.', 'Quand une température est définie, l\'unité de température est requise.'),
	('WHO classification', '', 'WHO Classification', ''),
	('width', '', 'Width', 'Larg.'),
	('wife', '', 'Wife', 'Femme (mariée)'),
	('withdrawn', '', 'Withdrawn', 'Désistement'),
	('work directly on aliquot to change aliquot information (status, used volume, etc)', '', 'Please work directly on aliquot to change aliquot information like \'status\', \'used volume\', etc (if required)!', 'Veuillez travailler directement sur l\'aliquot pour modifier des données de l\'aliquot telles que le statu, le volume utilisée, etc (si requis)!'),
	...
	('xenograft', '', 'Xenograft', 'Xénogreffe'),
	('year', '', 'Year', 'Année'),
	...
	('you are not allowed to use the generic version of that batch set.', '', 'You are not allowed to use the generic version of that batch set.', 'Vous n\'êtes pas autorisés à utiliser la version générique de cet ensemble de données.'),
	...
	('you can not define a tma block as a parent storage', '', 'You can not define a tma block as a parent storage!', 'Un bloc TMA ne peut être défini comme un entreposage \'parent\'!'),
	...
	('you can not store your storage inside itself', '', 'You can not store your storage inside itself!', 'L\'entreposage étudié ne peut pas être entreposé à l\'interieur de lui même!'),
	...
	('you cannot browse to the requested entities because there is no [%s] matching your request', '', 'You cannot browse to the requested entities because there is no [%s] matching your request!', 'Vous ne pouvez pas naviguer vers les entités demandées parce qu\'il n\'y a pas de [%s] correspondant à votre requête!'),
	...
	('you cannot realiquot those elements', '', 'You cannot realiquot those elements', 'Vous ne pouvez pas réaliquoter ces éléments'),
	('you cannot realiquot those elements together because they are of different types', '', 'You cannot realiquot those elements together because they are not both same sample type and aliquot type! ', 'Vous ne pouvez pas réalqiuoter ces éléments ensembles car ce ne sont pas et le même type d\'échantillon et le même type d\'aliquot!'),
	('you cannot resume a search that was made in a previous session', '', 'You cannot resume a search that was made in a previous session.', 'Vous ne pouvez pas reprendre une recherche qui a été faite dans une session antérieure.'),
	...
	('you have set more than one element in storage [%s] at position [%s, %s]', '', 'You have set more than one element in storage [%s] at position [%s, %s]', 'Vous avez défini plus d\'un élément dans l\'entreposage [%s] à la position [%s, %s]'),
	...
	('you need privileges on the following modules to manage participant inventory: %s', '', 'You need privileges on the following modules to manage participant inventory: %s.', 'Vous devez avoir des privilèges sur les modules suivants pour gérer l\'inventaire des participants: %s.'),
	...
	('your connection has been temporarily disabled', '', 'Due to too many invalid login attempts your account has been temporarily disabled', 'À la suite d\'un trop grand nombre de tentatives infructueuses de connexion, votre compte a été temporairement désactivé.'),
	...
	('your password', '', 'Enter Your Password', 'Saisissez votre mot de passe'),
	('your password has expired. Please change your password for security reason.', '', 'Your password has expired. Please change your password for security reasons.', 'Votre mot de passe a expiré. Veuillez changer votre mot de passe pour des raisons de sécurité.'),
