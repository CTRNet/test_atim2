<?php
	...
	$position_structure_type = 'edit';
	
	$structures->build($atim_structure_to_set_position, array('type' => $position_structure_type, 'links' => $position_structure_links, 'override' => $position_structure_override));
?>