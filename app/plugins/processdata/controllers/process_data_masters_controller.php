...
class ProcessDataMastersController extends ProcessDataAppController {

	var $components = array();
	
	var $uses = array(
		'Processdata.ProcessDataMaster',
		'Processdata.ProcessDataControl');
	
	var $paginate = array('ProcessDataMaster' => array('limit' => pagination_amount, 'order' => 'ProcessDataMaster.created ASC'));
	...
	function index() {
		...
		$this->set('process_data_controls_list', $this->ProcessDataControl->find('all', array('conditions' => array('ProcessDataControl.flag_active' => '1'))));
