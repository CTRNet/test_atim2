<?php
	...
	asort($specimen_filter_links);
	$specimen_filter_links['no filter'] = '/inventorymanagement/sample_masters/contentTreeView/' . $atim_menu_variables['Collection.id'] . '/-1';	
	...
	$structure_links = array(
		'tree'=>array(
			'SampleMaster' => array(
				'detail'=>'/inventorymanagement/sample_masters/detail/' . $atim_menu_variables['Collection.id'] . '/%%SampleMaster.id%%/1'
			),
			'AliquotMaster' => array(
