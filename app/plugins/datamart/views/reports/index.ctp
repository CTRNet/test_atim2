<?php
	...
	$structures->build($atim_structure, array('links' => $links, 'settings' => array('header' => __('activity report index', NULL), 'description' => __('activity report index description', NULL))));
?>