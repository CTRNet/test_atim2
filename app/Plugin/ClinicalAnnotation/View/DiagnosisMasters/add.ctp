<?php 
	$structure_links = array(
		'top'=>'/ClinicalAnnotation/DiagnosisMasters/add/'.$atim_menu_variables['Participant.id'].'/'.$atim_menu_variables['DiagnosisMaster.parent_id'].'/'.$atim_menu_variables['tableId'].'/',
		'bottom'=>array(
