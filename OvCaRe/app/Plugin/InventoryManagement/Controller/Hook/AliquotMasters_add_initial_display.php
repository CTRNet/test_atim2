<?php
	...
	foreach($samples as $view_sample){		
		$default_aliquot_data[$view_sample['ViewSample']['sample_master_id']] = array('aliquot_label' => (empty($view_sample['ViewSample']['identifier_value'])? 'n/a' : $view_sample['ViewSample']['identifier_value']));
