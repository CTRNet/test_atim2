<?php
	...
	if(empty($this->data) && ($event_type_title == 'ohriclinicalpresentation')) {
		...
		if (!empty($existing_presentation)) { 
			$this->atimFlash( 'a presentation can only be created once per participant','/clinicalannotation/event_masters/listall/'.$event_group.'/'.$participant_id);
		}
	}
