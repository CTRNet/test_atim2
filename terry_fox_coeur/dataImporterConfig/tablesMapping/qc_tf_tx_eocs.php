...
$fields = array(
	"participant_id" => $pkey,
	"tx_control_id" => array("Event Type" => array("surgery(ovarectomy)" => 20, "surgery(other)" => 15, "chimiotherapy" => 14)),
	"tx_method " => array("Event Type" => array("surgery(ovarectomy)" => 'ovarectomy', "surgery(other)" => 'surgery', "chimiotherapy" => 'chemotherapy')),
	"disease_site" => "@EOC",
