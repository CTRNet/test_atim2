...
('6th', '', '6th', '6ème'),
(':', '', ':', ':'),
('a LinkedModel exists for the deleted family history', '', 'Your data cannot be deleted! <br>Linked data exists for the deleted family history.', 'Vos données ne peuvent être supprimées! Des données sont liées à votre historique familiale.'),
...
('a system error has been detetced', '', 'A system error has been detetced!<br>Please try again or contact your system administrator.', 'Une erreur du système a été detectée!<br>Essayez de nouveau ou contactez votre administrateur du système.'),
('abnormal', '', 'Abnormal', ''),
...
('cell passage number should be a positif integer', '', 'Cell passage umber should be a positif integer!', 'Le nombre de passage cellulaire doit être un entier positif!'),
('cellular', '', 'Cellular', ''),
('celsius', '', '°C', '°C'),
...
('contamined', '', 'Contamined', 'Contaminé'),
('contract', '', 'Contract', ''),
...
('creation to storage spent time', '', 'Creation to Storage Spent Time', 'Temps écoullé entre la création et l''entreposage'),
...
('data not found', '', 'Data Not Found', 'Données innexistantes'),
('date', '', 'Date', 'Date'),
...
('deletion of this type of use is currently not supported from use list', '', 'Deletion of this type of use is not currently supported from use list!', 'La suppression de ce type d''utilisation n''est actuellement pas supporté à partir de cette liste!'),
('denied', '', 'Denied', ''),
...
('hemolyze signs', '', 'Hemolyze Signs', 'Signes d''hémolyse'),
('heparine', '', 'Heparine', 'Héparine'),
('her2', '', 'HER2', ''),
('histology', '', 'Histology', ''),
('home', '', 'Home', ''),
('hormonal', '', 'Hormonal', ''),
...
('Inventory - All', '', 'Inventory - All', 'Inventory - Indifférencié'),
('inventory management', '', 'Inventory Management', 'Gestion des échantillons'),
('inventory management description', '', 'Laboratory Information Management module. Manage and annotate all biobank samples. Supports pathologist review findings, quality control results, aliquot usage history and integration with Storage Management.', 'Module d''administration des informations du laboratoire. Administrer et annoter les ?©chantillons des biobanques. Supporte la v?©rification des r?©sultats des pathologistes, le contrôle de la qualité des résultats, l''historique de l''ut'),
...
('menopause status', '', 'Menopause Status', 'Status Ménopausique'),
('message', '', 'Message', 'Message'),
('message author', '', 'Author', 'Auteur'),
('message date_requested', '', 'Date Requested/Creation Date', 'Date de la demande/Date de céation'),
...
('more than one storages matche (at least one of) the selection label(s)', '', 'More than one storages matche (at least one of) the selection label(s)!', 'Plus d''un entreposage correspond à (au moins) un identifiant de sélection d''entreposage!'),
...
('no new item could be actualy added to the shipment', '', 'No new item could be actualy added to the shipment.', 'Aucun nouvel article ne peut actuellement être ajoutê à la commande.'),
('no new sample aliquot could be actually defined as realiquoted child', '', 'No new sample aliquot could be actually defined as realiquoted child!', 'Auncun nouvel aliquot de l''échantillon ne peut actuellement être défini comme aliquot ré-aliquoté (enfant)!'),
...
('no new sample aliquot could be actually defined as tested aliquot', '', 'No new sample aliquot could be actually defined as tested aliquot!', 'Auncun nouvel aliquot ne peut actuellement être défini comme aliquot ''testé''!'),
...
('number should be a positif integer', '', 'Number should be a positif integer!', 'Le nombre doit être un entier positif!'),
('obtained', '', 'Obtained', ''),
...
('realiquoted children selection', '', 'Realiquoted Children Selection', 'Selection des aliquots ré-aliquotés (enfant)'),
...
('remove_from_storage_help', '', 'Will remove aliquot from its storage deleting all storage information for this aliquot.', 'Supprimera l''aliquot de l''entreposage en éffaçant les données d''entreposage de l''aliquot'),
...
('sop_type', '', 'Type', ''),
('sop_version', '', 'Version', ''),
('Sorry, new password was not entered correctly.', '', 'Sorry, new password was not entered correctly.', 'Le nouveau mot de passe n''a pas été saisi correctemenet.'),
...
('stor_selection_label_defintion', '', 'Label built by the system joining all short labels of the storage parents and the studied parent starting from the root (ex: freezer, fridge, room) to the studied storage and separating all short labels by ''-''.', 'Libélé construit par le systême en concatenant tous les identifiants courts des entreposages ''parents'' ainsi que celui de l''entreposage étudié à partir du parent initial (ex: frigidaire, etc) jusqu''à l''entre'),
('stor_short_label_defintion', '', 'Short label written on the storage to identify this one.', 'Libélé court écrit sur l''entreposage pour identifier ce dernier.'),
('street', '', 'Street', 'Rue'),
('study', '', 'Study', 'Étude'),
('study_$', '', '$', '$'),
...
('use_help', '', 'Only selected rows will be taken in consideration!', 'Seul les lignes sélectionnées seront prises en considération!'),
('value', '', 'Value', ''),
('value is required', '', 'The value is required!', 'La valeur est requise!'),
('version number', '', 'Version Number', ''),
('very good', '', 'Very good', 'Trés bon'),
...
('You are not authorized to access that location.', '', 'You are not authorized to access that location.', 'Vous n''êtes pas authorisé à accéder cette page.'),
('your data has been deleted', '', 'Your data has been deleted.', 'Vos données ont été supprimées.'),
('your data has been deleted - update the aliquot in stock data', '', 'Your data has been deleted. <br>Please update the ''In Stock'' value for your aliquot if required.', 'Votre donnêe à êtê supprimée. <br>Veuillez mettre à jour la valeur de la donnée ''En stock'' de votre aliquot au besoin.'),
('your data has been removed - update the aliquot in stock data', '', 'Your data has been removed. <br>Please update the ''In Stock'' value for your aliquot if required.', 'Votre donnêe à êtê enlevée. <br>Veuillez mettre à jour la valeur de la donnée ''En stock'' de votre aliquot au besoin.'),
