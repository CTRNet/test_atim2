...
('inventory management description', 'global', 'Laboratory Information Management module. Manage and annotate all biobank samples. Supports pathologist review findings, quality control results, aliquot usage history and integration with Storage Management.', "Module d'administration des informations du laboratoire. Administrer et annoter les échantillons des biobanques. Supporte la vérification des résultats des pathologistes, le contr&ocirc;le de la qualit&eacute; des r&eacute;sultats, l'historique de l'utilisation des aliquots et l'int&eacute;gration avec l'administration de l'entreposage.");
