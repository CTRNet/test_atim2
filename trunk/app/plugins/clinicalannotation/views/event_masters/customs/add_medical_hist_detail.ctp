...
pr('clean up /views/envet_masters/ folder');
	...
	$structure_links = array(
		'top'=>'/clinicalannotation/event_masters/addMedicalHistDetail/'.$atim_menu_variables['EventMaster.event_group'].'/'.$atim_menu_variables['Participant.id'].'/'.$atim_menu_variables['EventMaster.id'].'/'.$atim_menu_variables['EventExtend.disease_type'],
	...
	// BUILD FORM
	$structures->build( $event_extend_structure, array('links' => $structure_links, 'type' => 'add', 'settings' => $structure_settings, 'override' => $structure_override));
