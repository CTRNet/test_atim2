<?php
	...
	$dropdown_options['StorageMaster.parent_storage_coord_x'] = $a_coord_x_list;
	$dropdown_options['StorageMaster.parent_storage_coord_y'] = $a_coord_y_list;
	
	$final_atim_structure = $atim_structure_to_set_position; 
	$final_options = array('type' => 'edit', 'links' => $position_structure_links, 'override' => $position_structure_override, 'dropdown_options' => $dropdown_options);
