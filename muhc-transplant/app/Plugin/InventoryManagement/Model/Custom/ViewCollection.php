...
LEFT JOIN misc_identifiers AS MiscIdentifier ON Collection.misc_identifier_id = MiscIdentifier.id AND MiscIdentifier.deleted <> 1 
	...
	function summary($variables=array()) {
		...
		if(isset($variables['Collection.id'])) {
			...
			$muhc_coded_identifier_transplant_nbr = empty($collection_data['ViewCollection']['muhc_coded_identifier_transplant_nbr'])? '?' : $collection_data['ViewCollection']['muhc_coded_identifier_transplant_nbr'];
			$muhc_irb_nbr = '?';
			...
			$label_1 = "$muhc_irb_nbr #$muhc_coded_identifier_transplant_nbr ";
