...
$header = array('title' => __('icd9tx code picker', true), 'description' => __('select an icd9tx code', true));
$index_link_prefix = "/codingicd/CodingIcd9txs/search/";
$links = array(
	'index' => array('detail' => $index_link_prefix.'%%CodingIcd.id%%'),
	'bottom' => array('back' => '/codingicd/CodingIcd9txs/tool/'.$use_icd_type));
