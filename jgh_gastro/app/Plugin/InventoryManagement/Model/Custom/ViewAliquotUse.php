...
IF(Shipment.qc_gastro_central_bank_order, 'received aliquot - shipement', 'aliquot shipment') AS use_definition,
	...
	function getUseDefinitions() {
		$result = array(
				...
				'received aliquot - shipement'	=> __('received aliquot - shipement')
		);
