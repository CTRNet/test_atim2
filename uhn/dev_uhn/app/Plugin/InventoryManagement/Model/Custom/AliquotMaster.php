...
class AliquotMasterCustom extends AliquotMaster
{
    ...
    {
        $queryToUpdate = "UPDATE aliquot_masters am JOIN aliquot_controls ac ON am.aliquot_control_id = ac.id "
				. "SET am.barcode = CONCAT(UPPER(LEFT(ac.aliquot_type,1)),am.id) "
				. "WHERE am.barcode IS NULL OR am.barcode LIKE '';";
