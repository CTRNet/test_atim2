...
/**
 * @param string $str The variable with accent
 * @return string replace the accent letters to normal letters like 'é' to 'e' and also '-' to '' and space to X (For ramq number in Quebec)  
 */
function normalizeChars($str, $space=true)
{
    ...
    $str =  strtoupper(strtr($str, $unwanted_array));
    return $str;
}
