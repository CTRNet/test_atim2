...
#TODO validate we do not need to drop/recreate keys
...
UPDATE sample_controls SET form_alias='sd_der_pbmcs' WHERE id='8';
UPDATE sample_controls SET form_alias='sd_der_dnas' WHERE id='12';
UPDATE sample_controls SET form_alias='sd_der_rnas' WHERE id='13';
UPDATE sample_controls SET detail_tablename='sd_der_urine_cons' WHERE id='14';
UPDATE sample_controls SET detail_tablename='sd_der_urine_cents' WHERE id='15';
UPDATE sample_controls SET detail_tablename='sd_der_amp_rnas' WHERE id='17';
#TODO: amp_rnas had a form called  sd_der_amplified_rnas -> need to reproduce it
UPDATE sample_controls SET detail_tablename='sd_der_b_cells' WHERE id='18';
UPDATE sample_controls SET detail_tablename='sd_der_tiss_lysates' WHERE id='101';
UPDATE sample_controls SET detail_tablename='sd_der_tiss_susps' WHERE id='102';
UPDATE sample_controls SET detail_tablename='sd_der_pw_cells' WHERE id='106';
UPDATE sample_controls SET detail_tablename='sd_der_pw_sups' WHERE id='107';
UPDATE sample_controls SET detail_tablename='sd_der_cystic_fl_cells' WHERE id='108';
UPDATE sample_controls SET detail_tablename='sd_der_cystic_fl_sups' WHERE id='109';
UPDATE sample_controls SET detail_tablename='sd_der_ascite_cells' WHERE id='5';
UPDATE sample_controls SET detail_tablename='sd_der_ascite_sups' WHERE id='6';
...
#TODO validate short_label required size before updating
