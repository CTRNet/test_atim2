...
UPDATE  sample_to_aliquot_controls, sample_controls
SET sample_to_aliquot_controls.status = 'inactive'
WHERE sample_to_aliquot_controls.sample_control_id = sample_controls.id
AND sample_controls.sample_type IN ('pericardial fluid', 'pleural fluid');
...
-- *** cell culture ***
((SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'cell culture' AND al.aliquot_type = 'tube' AND sta_ctrl.status = 'active'),
(SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'cell culture' AND al.aliquot_type = 'tube' AND sta_ctrl.status = 'active'),
'active'),
((SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
...
-- *** other fluid cell ***
((SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'other fluid cell' AND al.aliquot_type = 'tube'),
(SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'other fluid cell' AND al.aliquot_type = 'tube'),
'active'),

-- *** other fluid supernatant ***
((SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'other fluid supernatant' AND al.aliquot_type = 'tube'),
(SELECT sta_ctrl.id FROM sample_controls AS samp INNER JOIN sample_to_aliquot_controls AS sta_ctrl ON samp.id = sta_ctrl.sample_control_id INNER JOIN aliquot_controls AS al ON sta_ctrl.aliquot_control_id = al.id
WHERE samp.sample_type = 'other fluid supernatant' AND al.aliquot_type = 'tube'),
'active'),
...
ALTER TABLE ad_tissue_slides
    DROP FOREIGN KEY ad_tissue_slides_ibfk_4;
...
UPDATE collections SET bank_id = (SELECT id FROM banks WHERE name LIKE 'Breast%') WHERE bank = 'breast';     
UPDATE collections SET bank_id = (SELECT id FROM banks WHERE name LIKE 'Ovarian%') WHERE bank = 'ovary';   
UPDATE collections SET bank_id = (SELECT id FROM banks WHERE name LIKE 'Prostate%') WHERE bank = 'prostate'; 
UPDATE collections SET bank_id = (SELECT id FROM banks WHERE name LIKE 'Kidney%') WHERE bank = 'kidney'; 
UPDATE collections SET bank_id = (SELECT id FROM banks WHERE name LIKE 'ead&Neck%') WHERE bank = 'head and neck'; 
...
(4, 2, 'Users Breast/Sein', '2010-05-06 11:34:10', '2010-05-06 11:34:10'),
(5, 3, 'Users Ovarian/Ovaire', '2010-05-06 12:22:12', '2010-05-06 12:22:12'),
(6, 4, 'Users Prostate', '2010-05-06 12:24:54', '2010-05-06 12:24:54'),
(7, 1, 'Migration', '2010-05-06 12:29:52', '2010-05-06 12:29:52'),
(8, 5, 'Users Head&Neck/Tête&cou', '2010-05-06 12:37:54', '2010-05-06 12:37:54'),
(9, 6, 'Users Kidney/Rein', '2010-05-06 12:39:44', '2010-05-06 12:39:44');
