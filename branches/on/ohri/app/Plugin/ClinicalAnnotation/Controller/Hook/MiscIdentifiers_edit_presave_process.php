<?php
	...
	&& ($misc_identifier_data['MiscIdentifier']['identifier_value'] != $this->request->data['MiscIdentifier']['identifier_value'])) {
		if(!$this->MiscIdentifier->isDuplicatedIdentifierValue($misc_identifier_data['MiscIdentifierControl']['id'], $this->request->data['MiscIdentifier']['identifier_value'])) {
