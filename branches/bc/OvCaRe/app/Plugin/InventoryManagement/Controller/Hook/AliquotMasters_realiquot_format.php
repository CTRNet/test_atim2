<?php
	...
	$this->Structures->set('used_aliq_in_stock_details,ovcare_used_aliq_in_stock_details', 'in_stock_detail', array('model_table_assoc' => array('AliquotDetail' => 'tmp_detail_table')));
	...
	$this->Structures->set('used_aliq_in_stock_details,ovcare_used_aliq_in_stock_details,used_aliq_in_stock_detail_volume', 'in_stock_detail_volume', array('model_table_assoc' => array('AliquotDetail' => 'tmp_detail_table')));
