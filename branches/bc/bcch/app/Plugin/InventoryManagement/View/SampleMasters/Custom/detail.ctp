<?php
	...
	**/
	...
	$structure_links['bottom'] = array(
		...
		'print easyblood labels'	=> array('link' => '/InventoryManagement/SampleMasters/printSampleLabels/model:SampleMaster/id:'.$atim_menu_variables['SampleMaster.id'], 'icon' => 'barcode'),
