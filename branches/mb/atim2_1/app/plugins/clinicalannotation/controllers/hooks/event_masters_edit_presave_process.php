<?php
				...
				if ($event_master_data['EventMaster']['event_type']=='control followup' && $event_master_data['EventMaster']['disease_site']=='cll'){
				...
				if (($event_master_data['EventMaster']['event_type']=='followup' || $event_master_data['EventMaster']['event_type']=='presentation') && $event_master_data['EventMaster']['disease_site']=='cll'){
				...
				if (($event_master_data['EventMaster']['event_type']=='followup' || $event_master_data['EventMaster']['event_type']=='presentation') && $event_master_data['EventMaster']['disease_site']=='mmy'){
