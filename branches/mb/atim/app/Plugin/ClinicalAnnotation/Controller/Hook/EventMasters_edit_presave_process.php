<?php
				...
				if ($event_master_data['EventMaster']['event_control_id']==41 ){
				...
				if ($event_master_data['EventMaster']['event_control_id']==44 || $event_master_data['EventMaster']['event_control_id']==45){
				 ...
				 if ($diff_in_yrs > 0  && $event_master_data['EventMaster']['event_control_id']==44){
				 $this->request->data['EventDetail']['age_at_presentation']=$diff_in_yrs;
                 }
				 // end diff in years


				 if ($diff_in_yrs > 0 && $event_master_data['EventMaster']['event_control_id']==45){
				 ...
				 if ($event_master_data['EventMaster']['event_control_id']==45){
				...
				// CALC AGE AT LAB
				if ($event_master_data['EventMaster']['event_control_id']==47){
				 ...
				 if ($diff_in_yrs > 0 && $event_master_data['EventMaster']['event_control_id']==47){
				...
				if ($event_master_data['EventMaster']['event_control_id']==66 || $event_master_data['EventMaster']['event_control_id']==71 || $event_master_data['EventMaster']['event_control_id']==20){
