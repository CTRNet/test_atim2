<?php
				...
				if ($this->data['EventMaster']['event_control_id']==38){
				...
				if ($this->data['EventMaster']['event_control_id']==39 || $this->data['EventMaster']['event_control_id']==40){
				...
				if ($this->data['EventMaster']['event_control_id']==44 || $this->data['EventMaster']['event_control_id']==45){
				...
				// BREAST FU CONTROL ID 35
				 if ($this->data['EventMaster']['event_control_id']==35){
