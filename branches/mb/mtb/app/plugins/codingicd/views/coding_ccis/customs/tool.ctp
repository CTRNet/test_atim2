...
$this->Structures->build($atim_structure, array('type' => 'search', 'links' => array('top' => 'foo'), 
	'settings' => array('header' => __('search for a cci code', true), 'actions' => false)));
?>
<div id="results">
...
var popupSearch = function(){
	$.post(root_url + "codingicd/CodingCcis/search/<?php echo($use_icd_type); ?>/1", $("#me form").serialize(), function(data){
