		...
		if( $hook_link ) { require($hook_link); }
			...
			if($arr_allow_deletion['allow_deletion']) {
				...
				if( $this->StudyInvestigator->atimDelete( $study_investigator_id ) ) {
					...
					$this->atimFlash(__('error deleting data - contact administrator.'), '/Study/StudyInvestigators/listall/'.$study_summary_id );
				}
			}else {
					$this->atimFlash(__($arr_allow_deletion['msg']), '/Study/StudyInvestigators/detail/'.$study_summary_id.'/'.$study_investigator_id);
			}
	}
}
