...
$this->Structures->build($atim_structure, array(
	...
	'links' => array(
		...
		'bottom' => array('cancel' => $cancel_link)
	),
	'settings' => array(
		'header' => array(
			'title' => __('aliquots') . ' - ' . __('batch edit'),
			'description' => __('you are about to edit %d element(s)', substr_count($aliquot_ids, ',') + 1)
		),
		'confirmation_msg' => __('batch_edit_confirmation_msg')
	),
	'extras' => $this->Form->text('aliquot_ids',
			array("type" => "hidden", "id" => false, "value" => $aliquot_ids)) . $this->Form->text('cancel_link',
			array("type" => "hidden", "id" => false, "value" => $cancel_link))
