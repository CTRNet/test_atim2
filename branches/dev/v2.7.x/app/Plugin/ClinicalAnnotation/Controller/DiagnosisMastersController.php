	...
	function delete( $participant_id, $diagnosis_master_id ) {
		...
		if ($arr_allow_deletion['allow_deletion']) {
			if( $this->DiagnosisMaster->atimDelete( $diagnosis_master_id ) ) {
				...
				$this->atimFlash(__('error deleting data - contact administrator'), '/ClinicalAnnotation/DiagnosisMasters/listall/'.$participant_id );
			}
		} else {
			$this->atimFlash(__($arr_allow_deletion['msg']), '/ClinicalAnnotation/DiagnosisMasters/detail/'.$participant_id.'/'.$diagnosis_master_id);
		}		
	}
