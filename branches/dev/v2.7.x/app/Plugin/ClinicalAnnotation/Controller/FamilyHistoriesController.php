...
class FamilyHistoriesController extends ClinicalAnnotationAppController {
	...
	public function listall($participant_id) {
		...
		$this->request->data = $this->paginate($this->FamilyHistory,
			array('FamilyHistory.participant_id' => $participant_id));
	...
	public function detail($participant_id, $family_history_id) {
		// MANAGE DATA
		...
		$this->set('atim_menu_variables',
			array('Participant.id' => $participant_id, 'FamilyHistory.id' => $family_history_id));
		...
		if (empty($this->request->data)) {
			...
			if (empty($errors)) {
				...
				$this->atimFlash(__('your data has been saved'),
					'/ClinicalAnnotation/FamilyHistories/listall/' . $participant_id);
	...
	public function edit($participant_id, $family_history_id) {
			...
			if ($submitted_data_validates) {
				...
				if ($this->FamilyHistory->save($this->request->data)) {
					...
					$this->atimFlash(__('your data has been updated'),
						'/ClinicalAnnotation/FamilyHistories/detail/' . $participant_id . '/' . $family_history_id);
				}
			}
		}
	}

	public function delete($participant_id, $family_history_id) {
