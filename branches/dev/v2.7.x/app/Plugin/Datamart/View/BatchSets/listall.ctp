...
$add_to_batchset_hidden_field = $this->Form->input('BatchSet.id',
	array('type' => 'hidden', 'value' => $data_for_detail['BatchSet']['id']));
...
if ($display_unlock_button) {
	$structure_links['bottom'] = array_merge(array('unlock' => '/Datamart/BatchSets/unlock/' . $atim_menu_variables['BatchSet.id']),
