...
class CodingIcdAppModel extends AppModel {
	...
	function getDescription($id) {
		...
		$data = $this->find('first',
			array('conditions' => array('id' => $id), 'fields' => array($lang . "_description")));
		$description = '';
	...
	/**
	 * Convert CodingIcd* data arrays to have them use the generic CodingIcd model so that we only have 2 CodingIcd
	 * structures
	 *
