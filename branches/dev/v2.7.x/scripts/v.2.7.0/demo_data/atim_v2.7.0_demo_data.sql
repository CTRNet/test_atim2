...
-- Dumping data for table atim2.ad_blocks: ~0 rows (approximately)
...
-- Dumping data for table atim2.ad_blocks_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ad_blocks_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ad_blocks_revs` ENABLE KEYS */;


-- Dumping data for table atim2.ad_tissue_cores: ~0 rows (approximately)
...
-- Dumping data for table atim2.ad_tissue_cores_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ad_tissue_cores_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ad_tissue_cores_revs` ENABLE KEYS */;


-- Dumping data for table atim2.ad_tissue_slides: ~0 rows (approximately)
...
-- Dumping data for table atim2.ad_tissue_slides_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ad_tissue_slides_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ad_tissue_slides_revs` ENABLE KEYS */;

-- Dumping data for table atim2.ad_tubes: ~0 rows (approximately)
...
-- Dumping data for table atim2.ad_tubes_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ad_tubes_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ad_tubes_revs` ENABLE KEYS */;


-- Dumping data for table atim2.aliquot_internal_uses: ~0 rows (approximately)
...
-- Dumping data for table atim2.aliquot_internal_uses_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `aliquot_internal_uses_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `aliquot_internal_uses_revs` ENABLE KEYS */;



-- Dumping data for table atim2.aliquot_masters: ~0 rows (approximately)
...
INSERT INTO `aliquot_masters` (`id`, `barcode`, `aliquot_label`, `aliquot_control_id`, `collection_id`, `sample_master_id`, `sop_master_id`, `initial_volume`, `current_volume`, `in_stock`, `in_stock_detail`, `use_counter`, `study_summary_id`, `storage_datetime`, `storage_datetime_accuracy`, `storage_master_id`, `storage_coord_x`, `storage_coord_y`, `product_code`, `notes`, `created`, `created_by`, `modified`, `modified_by`, `deleted`) VALUES
	...
	(18, 'tb14', 'r41', 1, 3, 2, NULL, NULL, NULL, 'yes - available', '', 0, NULL, '2010-03-01 00:00:00', 'h', 31, '1', 'D', NULL, NULL, '2012-07-31 19:45:07', 1, '2012-07-31 19:45:07', 1, 0),
	...
	(42, 'tistb6741', '', 1, 4, 7, NULL, NULL, NULL, 'yes - available', '', 0, NULL, '2004-06-05 10:30:00', 'c', 14, '70', '', NULL, NULL, '2012-07-31 20:47:49', 1, '2012-07-31 20:47:49', 1, 0),
	(43, 'tistb6742', '', 1, 4, 7, NULL, NULL, NULL, 'yes - available', '', 0, NULL, '2004-06-05 10:30:00', 'c', 14, '71', '', NULL, NULL, '2012-07-31 20:47:50', 1, '2012-07-31 20:47:50', 1, 0),
	...
	(48, '39021-bl2', '', 3, 1, 10, NULL, 2.00000, 2.00000, 'yes - available', '', 0, NULL, '2001-06-23 00:00:00', 'c', 13, '2', 'B', NULL, NULL, '2012-08-01 13:11:21', 1, '2012-08-01 13:14:22', 1, 0),
	...
	(98, 'QP9387.d4', '', 29, 3, 12, NULL, 1.00000, 1.00000, 'yes - available', '', 0, NULL, '2012-08-01 17:46:00', 'c', 11, '3', 'A', NULL, NULL, '2012-08-01 13:49:16', 1, '2012-08-02 19:54:31', 1, 0),
...
-- Dumping data for table atim2.aliquot_masters_revs: ~0 rows (approximately)
...
-- Dumping data for table atim2.banks: ~0 rows (approximately)
...
-- Dumping data for table atim2.banks_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `banks_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `banks_revs` ENABLE KEYS */;


-- Dumping data for table atim2.cd_nationals: ~0 rows (approximately)
/*!40000 ALTER TABLE `cd_nationals` DISABLE KEYS */;
INSERT INTO `cd_nationals` (`consent_master_id`) VALUES
	(1),
	(2),
	(3);
/*!40000 ALTER TABLE `cd_nationals` ENABLE KEYS */;

-- Dumping data for table atim2.cd_nationals_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `cd_nationals_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `cd_nationals_revs` ENABLE KEYS */;

-- Dumping data for table atim2.collections: ~0 rows (approximately)
...
-- Dumping data for table atim2.collections_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `collections_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `collections_revs` ENABLE KEYS */;

-- Dumping data for table atim2.consent_masters: ~0 rows (approximately)
...
-- Dumping data for table atim2.consent_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `consent_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `consent_masters_revs` ENABLE KEYS */;


-- Dumping data for table atim2.derivative_details: ~0 rows (approximately)
...
-- Dumping data for table atim2.derivative_details_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `derivative_details_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `derivative_details_revs` ENABLE KEYS */;


-- Dumping data for table atim2.diagnosis_masters: ~0 rows (approximately)
/*!40000 ALTER TABLE `diagnosis_masters` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `diagnosis_masters` ENABLE KEYS */;

-- Dumping data for table atim2.diagnosis_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `diagnosis_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `diagnosis_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.drugs: ~0 rows (approximately)
...
-- Dumping data for table atim2.drugs_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `drugs_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `drugs_revs` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_bloods: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_bloods` DISABLE KEYS */;
INSERT INTO `dxd_bloods` (`diagnosis_master_id`, `text_field`) VALUES
	(1, '');
/*!40000 ALTER TABLE `dxd_bloods` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_bloods_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_bloods_revs` DISABLE KEYS */;
INSERT INTO `dxd_bloods_revs` (`diagnosis_master_id`, `text_field`, `version_id`, `version_created`) VALUES
	(1, '', 1, '2012-07-31 15:19:56');
/*!40000 ALTER TABLE `dxd_bloods_revs` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_progressions: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_progressions` DISABLE KEYS */;
INSERT INTO `dxd_progressions` (`diagnosis_master_id`) VALUES
	(7);
/*!40000 ALTER TABLE `dxd_progressions` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_progressions_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_progressions_revs` DISABLE KEYS */;
INSERT INTO `dxd_progressions_revs` (`diagnosis_master_id`, `version_id`, `version_created`) VALUES
	(7, 1, '2012-07-31 18:50:03');
/*!40000 ALTER TABLE `dxd_progressions_revs` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_remissions: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_remissions` DISABLE KEYS */;
INSERT INTO `dxd_remissions` (`diagnosis_master_id`) VALUES
	(2),
	(4),
	(8);
/*!40000 ALTER TABLE `dxd_remissions` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_remissions_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_remissions_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `dxd_remissions_revs` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_secondaries: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_secondaries` DISABLE KEYS */;
INSERT INTO `dxd_secondaries` (`diagnosis_master_id`) VALUES
	(5);
/*!40000 ALTER TABLE `dxd_secondaries` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_secondaries_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_secondaries_revs` DISABLE KEYS */;
INSERT INTO `dxd_secondaries_revs` (`diagnosis_master_id`, `version_id`, `version_created`) VALUES
	(5, 1, '2012-07-31 15:42:36');
/*!40000 ALTER TABLE `dxd_secondaries_revs` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_tissues: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_tissues` DISABLE KEYS */;
INSERT INTO `dxd_tissues` (`diagnosis_master_id`, `laterality`) VALUES
	(3, 'not applicable'),
	(6, 'not applicable'),
	(9, '');
/*!40000 ALTER TABLE `dxd_tissues` ENABLE KEYS */;

-- Dumping data for table atim2.dxd_tissues_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `dxd_tissues_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `dxd_tissues_revs` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_clinical_followups: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_clinical_followups` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ed_all_clinical_followups` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_clinical_followups_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_clinical_followups_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ed_all_clinical_followups_revs` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_clinical_presentations: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_clinical_presentations` DISABLE KEYS */;
INSERT INTO `ed_all_clinical_presentations` (`weight`, `height`, `event_master_id`) VALUES
	(87.00, 176.00, 2),
	(78.00, 165.00, 4);
/*!40000 ALTER TABLE `ed_all_clinical_presentations` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_clinical_presentations_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_clinical_presentations_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ed_all_clinical_presentations_revs` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_lifestyle_smokings: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_lifestyle_smokings` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ed_all_lifestyle_smokings` ENABLE KEYS */;

-- Dumping data for table atim2.ed_all_lifestyle_smokings_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `ed_all_lifestyle_smokings_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ed_all_lifestyle_smokings_revs` ENABLE KEYS */;

-- Dumping data for table atim2.event_masters: ~0 rows (approximately)
...
-- Dumping data for table atim2.event_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `event_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `event_masters_revs` ENABLE KEYS */;


-- Dumping data for table atim2.family_histories: ~0 rows (approximately)
...
-- Dumping data for table atim2.family_histories_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `family_histories_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `family_histories_revs` ENABLE KEYS */;

-- Dumping data for table atim2.misc_identifiers: ~0 rows (approximately)
...
-- Dumping data for table atim2.misc_identifiers_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `misc_identifiers_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `misc_identifiers_revs` ENABLE KEYS */;

-- Dumping data for table atim2.misc_identifier_controls: ~0 rows (approximately)
/*!40000 ALTER TABLE `misc_identifier_controls` DISABLE KEYS */;
INSERT INTO `misc_identifier_controls` (`id`, `misc_identifier_name`, `flag_active`, `display_order`, `autoincrement_name`, `misc_identifier_format`, `flag_once_per_participant`, `flag_confidential`, `flag_unique`, `pad_to_length`, `reg_exp_validation`, `user_readable_format`, `flag_link_to_study`) VALUES
	(1, 'BR_Nbr', 1, 1, 'br', 'BR%%key_increment%%', 0, 0, 1, 0, '', '', 0),
	(2, 'PR_Nbr', 1, 2, 'pr', 'PR%%key_increment%%', 0, 0, 1, 0, '', '', 0),
	(3, 'hospital number', 1, 4, '', '', 1, 1, 1, 0, '', '', 0);
/*!40000 ALTER TABLE `misc_identifier_controls` ENABLE KEYS */;

-- Dumping data for table atim2.orders: ~0 rows (approximately)
...
-- Dumping data for table atim2.orders_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `orders_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `orders_revs` ENABLE KEYS */;

-- Dumping data for table atim2.order_items: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_items` DISABLE KEYS */;
INSERT INTO `order_items` (`id`, `date_added`, `date_added_accuracy`, `added_by`, `status`, `created`, `created_by`, `modified`, `modified_by`, `order_line_id`, `shipment_id`, `aliquot_master_id`, `deleted`, `order_id`) VALUES
	(1, '2012-08-09', 'c', 'tech. 2', 'shipped', '2012-08-01 13:58:05', 1, '2012-08-01 13:59:43', 1, 1, 1, 101, 0, 1),
	(2, '2012-08-09', 'c', 'tech. 2', 'shipped', '2012-08-01 13:58:06', 1, '2012-08-01 13:59:44', 1, 1, 1, 102, 0, 1),
	(3, '2012-08-09', 'c', 'tech. 2', 'shipped', '2012-08-01 13:58:07', 1, '2012-08-01 13:59:45', 1, 1, 1, 103, 0, 1),
	(4, '2012-08-09', 'c', 'tech. 2', 'shipped', '2012-08-01 13:58:07', 1, '2012-08-01 13:59:46', 1, 1, 1, 104, 0, 1),
	(5, '2012-08-09', 'c', 'tech. 2', 'shipped', '2012-08-01 13:58:08', 1, '2012-08-01 13:59:47', 1, 1, 1, 105, 0, 1);
/*!40000 ALTER TABLE `order_items` ENABLE KEYS */;

-- Dumping data for table atim2.order_items_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_items_revs` DISABLE KEYS */;
INSERT INTO `order_items_revs` (`id`, `date_added`, `date_added_accuracy`, `added_by`, `status`, `modified_by`, `order_line_id`, `shipment_id`, `aliquot_master_id`, `version_id`, `version_created`, `order_id`) VALUES
	(1, '2012-08-09', 'c', 'tech. 2', 'pending', 1, 1, NULL, 101, 1, '2012-08-01 13:58:05', 1),
	(2, '2012-08-09', 'c', 'tech. 2', 'pending', 1, 1, NULL, 102, 2, '2012-08-01 13:58:06', 1),
	(3, '2012-08-09', 'c', 'tech. 2', 'pending', 1, 1, NULL, 103, 3, '2012-08-01 13:58:07', 1),
	(4, '2012-08-09', 'c', 'tech. 2', 'pending', 1, 1, NULL, 104, 4, '2012-08-01 13:58:07', 1),
	(5, '2012-08-09', 'c', 'tech. 2', 'pending', 1, 1, NULL, 105, 5, '2012-08-01 13:58:08', 1),
	(1, '2012-08-09', 'c', 'tech. 2', 'shipped', 1, 1, 1, 101, 6, '2012-08-01 13:59:43', 1),
	(2, '2012-08-09', 'c', 'tech. 2', 'shipped', 1, 1, 1, 102, 7, '2012-08-01 13:59:44', 1),
	(3, '2012-08-09', 'c', 'tech. 2', 'shipped', 1, 1, 1, 103, 8, '2012-08-01 13:59:45', 1),
	(4, '2012-08-09', 'c', 'tech. 2', 'shipped', 1, 1, 1, 104, 9, '2012-08-01 13:59:46', 1),
	(5, '2012-08-09', 'c', 'tech. 2', 'shipped', 1, 1, 1, 105, 10, '2012-08-01 13:59:47', 1);
/*!40000 ALTER TABLE `order_items_revs` ENABLE KEYS */;

-- Dumping data for table atim2.order_lines: ~0 rows (approximately)
...
-- Dumping data for table atim2.order_lines_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `order_lines_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `order_lines_revs` ENABLE KEYS */;

-- Dumping data for table atim2.participants: ~0 rows (approximately)
...
-- Dumping data for table atim2.participants_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `participants_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `participants_revs` ENABLE KEYS */;

-- Dumping data for table atim2.pd_chemos: ~0 rows (approximately)
/*!40000 ALTER TABLE `pd_chemos` DISABLE KEYS */;
INSERT INTO `pd_chemos` (`protocol_master_id`) VALUES
	(1);
/*!40000 ALTER TABLE `pd_chemos` ENABLE KEYS */;

-- Dumping data for table atim2.pd_chemos_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `pd_chemos_revs` DISABLE KEYS */;
INSERT INTO `pd_chemos_revs` (`protocol_master_id`, `version_id`, `version_created`) VALUES
	(1, 1, '2012-07-31 15:28:36');
/*!40000 ALTER TABLE `pd_chemos_revs` ENABLE KEYS */;

-- Dumping data for table atim2.pe_chemos: ~0 rows (approximately)
/*!40000 ALTER TABLE `pe_chemos` DISABLE KEYS */;
INSERT INTO `pe_chemos` (`method`, `dose`, `frequency`, `drug_id`, `protocol_extend_master_id`) VALUES
	('IV: Intravenous', '', '', 1, 1),
	('IV: Intravenous', '', '', 5, 2);
/*!40000 ALTER TABLE `pe_chemos` ENABLE KEYS */;

-- Dumping data for table atim2.pe_chemos_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `pe_chemos_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `pe_chemos_revs` ENABLE KEYS */;

-- Dumping data for table atim2.protocol_extend_masters: ~0 rows (approximately)
/*!40000 ALTER TABLE `protocol_extend_masters` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `protocol_extend_masters` ENABLE KEYS */;

-- Dumping data for table atim2.protocol_extend_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `protocol_extend_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `protocol_extend_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.protocol_masters: ~0 rows (approximately)
/*!40000 ALTER TABLE `protocol_masters` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `protocol_masters` ENABLE KEYS */;

-- Dumping data for table atim2.protocol_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `protocol_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `protocol_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.quality_ctrls: ~0 rows (approximately)
...
-- Dumping data for table atim2.quality_ctrls_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `quality_ctrls_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `quality_ctrls_revs` ENABLE KEYS */;

-- Dumping data for table atim2.realiquotings: ~0 rows (approximately)
...
-- Dumping data for table atim2.realiquotings_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `realiquotings_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `realiquotings_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sample_masters: ~0 rows (approximately)
...
-- Dumping data for table atim2.sample_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sample_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sample_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sd_der_blood_cells: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_der_blood_cells` DISABLE KEYS */;
INSERT INTO `sd_der_blood_cells` (`sample_master_id`) VALUES
	(4);
/*!40000 ALTER TABLE `sd_der_blood_cells` ENABLE KEYS */;

-- Dumping data for table atim2.sd_der_blood_cells_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_der_blood_cells_revs` DISABLE KEYS */;
INSERT INTO `sd_der_blood_cells_revs` (`sample_master_id`, `version_id`, `version_created`) VALUES
	(4, 1, '2012-07-31 19:48:33');
/*!40000 ALTER TABLE `sd_der_blood_cells_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sd_der_dnas: ~0 rows (approximately)
...
-- Dumping data for table atim2.sd_der_dnas_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_der_dnas_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sd_der_dnas_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sd_der_plasmas: ~0 rows (approximately)
...
-- Dumping data for table atim2.sd_der_plasmas_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_der_plasmas_revs` DISABLE KEYS */;
INSERT INTO `sd_der_plasmas_revs` (`sample_master_id`, `version_id`, `version_created`) VALUES
	(6, 1, '2012-07-31 19:51:43');
/*!40000 ALTER TABLE `sd_der_plasmas_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sd_spe_bloods: ~0 rows (approximately)
...
-- Dumping data for table atim2.sd_spe_bloods_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_spe_bloods_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sd_spe_bloods_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sd_spe_tissues: ~0 rows (approximately)
...
-- Dumping data for table atim2.sd_spe_tissues_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sd_spe_tissues_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sd_spe_tissues_revs` ENABLE KEYS */;

-- Dumping data for table atim2.shipments: ~0 rows (approximately)
...
-- Dumping data for table atim2.shipments_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `shipments_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `shipments_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sopd_inventory_alls: ~0 rows (approximately)
/*!40000 ALTER TABLE `sopd_inventory_alls` DISABLE KEYS */;
INSERT INTO `sopd_inventory_alls` (`sop_master_id`) VALUES
	(1);
/*!40000 ALTER TABLE `sopd_inventory_alls` ENABLE KEYS */;

-- Dumping data for table atim2.sopd_inventory_alls_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sopd_inventory_alls_revs` DISABLE KEYS */;
INSERT INTO `sopd_inventory_alls_revs` (`sop_master_id`, `version_id`, `version_created`) VALUES
	(1, 1, '2012-07-31 17:57:41');
/*!40000 ALTER TABLE `sopd_inventory_alls_revs` ENABLE KEYS */;

-- Dumping data for table atim2.sop_masters: ~0 rows (approximately)
/*!40000 ALTER TABLE `sop_masters` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sop_masters` ENABLE KEYS */;

-- Dumping data for table atim2.sop_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `sop_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `sop_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.source_aliquots: ~0 rows (approximately)
...
-- Dumping data for table atim2.source_aliquots_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `source_aliquots_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `source_aliquots_revs` ENABLE KEYS */;

-- Dumping data for table atim2.specimen_details: ~0 rows (approximately)
...
-- Dumping data for table atim2.specimen_details_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `specimen_details_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `specimen_details_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_boxs: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_boxs_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_boxs_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `std_boxs_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_cupboards: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_cupboards_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_cupboards_revs` DISABLE KEYS */;
INSERT INTO `std_cupboards_revs` (`storage_master_id`, `version_id`, `version_created`) VALUES
	(15, 1, '2012-07-31 18:04:25');
/*!40000 ALTER TABLE `std_cupboards_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_freezers: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_freezers_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_freezers_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `std_freezers_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_racks: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_racks_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_racks_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `std_racks_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_shelfs: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_shelfs_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_shelfs_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `std_shelfs_revs` ENABLE KEYS */;

-- Dumping data for table atim2.std_tma_blocks: ~0 rows (approximately)
...
-- Dumping data for table atim2.std_tma_blocks_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `std_tma_blocks_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `std_tma_blocks_revs` ENABLE KEYS */;

-- Dumping data for table atim2.storage_masters: ~0 rows (approximately)
...
-- Dumping data for table atim2.storage_masters_revs: ~0 rows (approximately)
...
-- Dumping data for table atim2.structure_permissible_values_customs: ~39 rows (approximately)
/*!40000 ALTER TABLE `structure_permissible_values_customs` DISABLE KEYS */;
INSERT INTO `structure_permissible_values_customs` (`id`, `control_id`, `value`, `en`, `fr`, `display_order`, `use_as_input`, `created`, `created_by`, `modified`, `modified_by`, `deleted`) VALUES
	...
	(33, 11, 'TMA-blc 29X21', 'TMA-block 29X21', 'TMA-bloc 29X21', 0, 1, '2014-02-24 09:52:13', 1, '2014-02-24 09:52:13', 1, 0),
	...
	(56, 3, 'surg room 1', '', '', 0, 1, '2012-07-31 15:46:23', 1, '2012-07-31 15:46:23', 1, 0),
	(57, 3, 'surg  room 2', '', '', 0, 1, '2012-07-31 15:46:38', 1, '2012-07-31 15:46:38', 1, 0),
	(58, 1, 'res. assist. 1', '', '', 0, 1, '2012-07-31 15:49:10', 1, '2012-07-31 15:49:10', 1, 0),
	(59, 1, 'tech. 2', '', '', 0, 1, '2012-07-31 15:49:10', 1, '2012-07-31 15:49:10', 1, 0),
	(60, 1, 'tech. 1', '', '', 0, 1, '2012-07-31 15:49:10', 1, '2012-07-31 15:49:10', 1, 0),
	...
	(68, 13, 'mouse', 'Mouse', 'Souris', 0, 1, '2016-02-19 00:04:51', 1, '2016-02-19 00:04:51', 1, 0),
	(69, 14, 'liver', 'Liver', 'Foie', 0, 1, '2016-02-19 00:04:51', 1, '2016-02-19 00:04:51', 1, 0),
	(70, 14, 'mammary fat pad', 'Mammary Fat Pad', 'Tissu graisseux mammaire', 0, 1, '2016-02-19 00:04:51', 1, '2016-02-19 00:04:51', 1, 0),
	(71, 14, 'flank', 'Flank', 'Flanc', 0, 1, '2016-02-19 00:04:51', 1, '2016-02-19 00:04:51', 1, 0),
	(72, 15, 'liver', 'Liver', 'Foie', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(73, 15, 'lung', 'Lung', 'Poumon', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(74, 15, 'kidney', 'Kidney', 'Rein', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(75, 15, 'pancreas', 'Pancreas', 'Pancréas', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(76, 15, 'ovary', 'Ovary', 'Ovaire', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(77, 15, 'intestine', 'Intestine', 'Intestin', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(78, 15, 'heart', 'Heart', 'Coeur', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(79, 15, 'diaphragm', 'Diaphragm', 'Diaphragme', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0),
	(80, 15, 'subcutaneous tumor', 'Subcutaneous Tumor', 'Tumeur sous-cutanée', 0, 1, '2016-02-19 00:04:59', 1, '2016-02-19 00:04:59', 1, 0);
/*!40000 ALTER TABLE `structure_permissible_values_customs` ENABLE KEYS */;


-- Dumping data for table atim2.study_summaries: ~0 rows (approximately)
...
-- Dumping data for table atim2.study_summaries_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `study_summaries_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `study_summaries_revs` ENABLE KEYS */;


-- Dumping data for table atim2.treatment_extend_masters: ~0 rows (approximately)
/*!40000 ALTER TABLE `treatment_extend_masters` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `treatment_extend_masters` ENABLE KEYS */;

-- Dumping data for table atim2.treatment_extend_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `treatment_extend_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `treatment_extend_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.treatment_masters: ~0 rows (approximately)
...
-- Dumping data for table atim2.treatment_masters_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `treatment_masters_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `treatment_masters_revs` ENABLE KEYS */;

-- Dumping data for table atim2.txd_chemos: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_chemos` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txd_chemos` ENABLE KEYS */;

-- Dumping data for table atim2.txd_chemos_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_chemos_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txd_chemos_revs` ENABLE KEYS */;

-- Dumping data for table atim2.txd_radiations: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_radiations` DISABLE KEYS */;
INSERT INTO `txd_radiations` (`rad_completed`, `treatment_master_id`) VALUES
	('', 6);
/*!40000 ALTER TABLE `txd_radiations` ENABLE KEYS */;

-- Dumping data for table atim2.txd_radiations_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_radiations_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txd_radiations_revs` ENABLE KEYS */;

-- Dumping data for table atim2.txd_surgeries: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_surgeries` DISABLE KEYS */;
INSERT INTO `txd_surgeries` (`path_num`, `primary`, `treatment_master_id`) VALUES
	('R78EXC', NULL, 2),
	('', NULL, 5),
	('P938', NULL, 7);
/*!40000 ALTER TABLE `txd_surgeries` ENABLE KEYS */;

-- Dumping data for table atim2.txd_surgeries_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `txd_surgeries_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txd_surgeries_revs` ENABLE KEYS */;

-- Dumping data for table atim2.txe_chemos: ~0 rows (approximately)
/*!40000 ALTER TABLE `txe_chemos` DISABLE KEYS */;
INSERT INTO `txe_chemos` (`dose`, `method`, `drug_id`, `treatment_extend_master_id`) VALUES
	...
	('', 'IV: Intravenous', 1, 5),
	('', 'IV: Intravenous', 5, 6);
/*!40000 ALTER TABLE `txe_chemos` ENABLE KEYS */;

-- Dumping data for table atim2.txe_chemos_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `txe_chemos_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txe_chemos_revs` ENABLE KEYS */;

-- Dumping data for table atim2.txe_surgeries: ~0 rows (approximately)
/*!40000 ALTER TABLE `txe_surgeries` DISABLE KEYS */;
INSERT INTO `txe_surgeries` (`surgical_procedure`, `treatment_extend_master_id`) VALUES
	('SURG-90391', 8);
/*!40000 ALTER TABLE `txe_surgeries` ENABLE KEYS */;

-- Dumping data for table atim2.txe_surgeries_revs: ~0 rows (approximately)
/*!40000 ALTER TABLE `txe_surgeries_revs` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `txe_surgeries_revs` ENABLE KEYS */;

-- Dumping data for table atim2.user_logs: ~0 rows (approximately)
/*!40000 ALTER TABLE `user_logs` DISABLE KEYS */;
INSERT INTO `user_logs` (`id`, `user_id`, `url`, `visited`, `allowed`) VALUES
	(1, 1, '/ATiM/trunk/', '2012-08-07 18:33:46', 1),
	(2, 1, '/ATiM/trunk/Users/login', '2012-08-07 18:33:57', 1),
	(3, 1, '/ATiM/trunk/Menus', '2012-08-07 18:33:58', 1);
/*!40000 ALTER TABLE `user_logs` ENABLE KEYS */;

-- Dumping data for table atim2.versions: ~0 rows (approximately)
/*!40000 ALTER TABLE `versions` DISABLE KEYS */;
INSERT INTO `versions` (`id`, `version_number`, `date_installed`, `trunk_build_number`, `permissions_regenerated`, `branch_build_number`) VALUES
	(6, '2.5.0', '2014-02-24 14:50:22', '4792', 0, ''),
	(7, '2.5.1', '2014-02-24 14:50:32', '4820', 0, ''),
	(8, '2.5.2', '2014-02-24 14:50:41', '4882', 0, ''),
	(9, '2.5.3', '2014-02-24 14:50:51', '5107', 0, ''),
	(10, '2.5.4', '2014-02-24 14:50:56', '5152', 0, ''),
	(11, '2.6.0', '2014-02-24 14:52:56', '5596?', 0, 'n/a'),
	(12, '2.6.1', '2016-02-19 00:04:40', '5695', 0, 'n/a'),
	(13, '2.6.2', '2016-02-19 00:04:43', '5710', 0, 'n/a'),
	(14, '2.6.3', '2016-02-19 00:04:47', '5798', 0, 'n/a'),
	(15, '2.6.4', '2016-02-19 00:04:52', '6115', 0, 'n/a'),
	(16, '2.6.5', '2016-02-19 00:05:00', '6230', 0, 'n/a'),
	(17, '2.6.6', '2016-02-19 00:05:08', '6315', 0, 'n/a'),
	(18, '2.6.7', '2016-02-19 00:05:13', '????', 0, 'n/a'),
	(19, '2.7.0', '2016-02-19 00:10:38', '6401', 0, '6402');
/*!40000 ALTER TABLE `versions` ENABLE KEYS */;



-- Dumping data for table atim2.key_increments: ~2 rows (approximately)
/*!40000 ALTER TABLE `key_increments` DISABLE KEYS */;
INSERT INTO `key_increments` (`key_name`, `key_value`) VALUES
	('br', 124),
	('pr', 5943);
/*!40000 ALTER TABLE `key_increments` ENABLE KEYS */;
