...
if (! is_null($consent_control_data))
    $final_options['settings']['header']['description'] = __($consent_control_data['controls_type']);
...
if (! is_null($diagnosis_control_data))
    $final_options['settings']['header']['description'] = __($diagnosis_control_data['category']) . ' - ' . __($diagnosis_control_data['controls_type']);
...
if (! is_null($treatment_control_data))
    $final_options['settings']['header']['description'] = __($treatment_control_data['tx_method']) . (empty($treatment_control_data['disease_site']) ? '' : ' - ' . __($treatment_control_data['disease_site']));
...
if (! is_null($event_control_data))
    $final_options['settings']['header']['description'] = __($event_control_data['event_group']) . ' - ' . __($event_control_data['event_type']) . (empty($event_control_data['disease_site']) ? '' : ' - ' . __($event_control_data['disease_site']));
...
$final_options['links'] = array(
    'bottom' => $structure_bottom_links
);
