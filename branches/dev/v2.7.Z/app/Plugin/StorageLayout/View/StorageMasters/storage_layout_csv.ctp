            ...
            if (sizeof($csv_layout_data[0]) == 1) {
                ...
                foreach ($csv_layout_data as $csv_layout_line_data) {
                    ...
                    $csv_data[] = array(
                        ...
                        (isset($x_y_values_to_cell_content_labels[$csv_layout_cell_data['x_y']]) ? implode(' / ', $x_y_values_to_cell_content_labels[$csv_layout_cell_data['x_y']]) : '')
                    );
                    unset($x_y_values_to_cell_content_labels[$csv_layout_cell_data['x_y']]);
                }
            } else {
