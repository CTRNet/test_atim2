<?php 
	...
	if (empty($this->request->data)) $this->Participant->setNextUrlToFlashForVisitDataEntry($participant_id, 'TreatmentControl', $tx_control_data['TreatmentControl'], $this->passedArgs);
