<?php
	...
	if(Configure::read('procure_atim_version') == 'BANK') $final_options['links']['bottom']['copy for new collection'] = array('link' => '/InventoryManagement/collections/add/0/'.$atim_menu_variables['Collection.id'], 'icon' => 'copy');