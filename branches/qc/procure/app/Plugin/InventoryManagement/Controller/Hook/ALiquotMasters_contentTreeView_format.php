...
foreach($this->request->data as &$tree_node){
	...
	if(isset($tree_node['AliquotMaster'])) {
		...
		//ALiquot is a transferred child
		if(isset($tree_node['Realiquoting']) && $tree_node['Realiquoting']['procure_central_is_transfer'] == '1') $procure_is_transferred_aliquot = true;
	}
