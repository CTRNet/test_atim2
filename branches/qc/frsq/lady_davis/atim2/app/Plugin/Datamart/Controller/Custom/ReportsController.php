...
class ReportsControllerCustom extends ReportsController {
		...
		if(array_key_exists('Participant', $parameters) && array_key_exists('id', $parameters['Participant'])) {
			...
			if(array_key_exists('ViewCollection', $parameters)) {
				if(array_key_exists('misc_identifier_value', $parameters['ViewCollection'])) {
					...
					if($misc_identifier_values) $criteria_array[] = "MiscIdentifier.identifier_value IN ('".implode("','", $misc_identifier_values)."')";
	...
	function participantIdentifiersSummary($parameters) {
		...
		foreach($misc_identifiers as $new_ident){
			...
			$ident_key = str_replace(array(' #',' ', '-'), array('','_','_'), $new_ident['MiscIdentifierControl']['misc_identifier_name']);
