<?php
	...
	if(empty($errors) && (strpos($child_aliquot_ctrl['AliquotControl']['detail_form_alias'], 'chus_dna_rna_weight') !== false)) {
		if($child_aliquot_ctrl['AliquotControl']['volume_unit'] != 'ul') $this->redirect('/Pages/err_plugin_record_err?method='.__METHOD__.',line='.__LINE__, null, true); 
