...
//*** PROCURE CHUM *****************************************************
			if(!isset($data[$participant_id]['MiscIdentifier'])) $data[$participant_id]['MiscIdentifier'] = $res['MiscIdentifier'];
//*** END PROCURE CHUM *****************************************************			
			$report_aliquot_key = '';
...
-- *** END PROCURE CHUM *****************************************************
		...
		foreach($participant_data as $new_participant) {
			...
			foreach($misc_identifier_model->find('all', array('conditions' => array('MiscIdentifier.participant_id' => $new_participant_id, 'MiscIdentifierControl.misc_identifier_name' => array('hospital number', 'ramq', /*** PROCURE CHUM ***/'prostate bank no lab','ramq nbr', 'hotel-dieu id nbr', 'notre-dame id nbr', 'saint-luc id nbr'/*** END PROCURE CHUM ***/)))) as $new_identifier) {
				$new_data = $record_template;
