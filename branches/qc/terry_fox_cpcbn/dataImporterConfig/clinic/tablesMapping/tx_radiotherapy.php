...
function txRadiotherapyPostRead(Model $m){
	...
	if(empty($m->values['Radiotherapy']) && $m->values['hormonotherapy'] != 'yes' && $m->values['chemotherapy'] != 'yes' && empty($m->values['Other treatments']) && !preg_match('/^[0-9\.,<]+$/', $m->values['PSA (ng/ml)'],$matches)) {
