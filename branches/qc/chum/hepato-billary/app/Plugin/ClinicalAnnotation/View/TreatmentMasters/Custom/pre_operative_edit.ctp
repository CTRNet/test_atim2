<?php 
	...
	$structure_links['bottom'] = array('cancel'=>'/ClinicalAnnotation/TreatmentMasters/preOperativeDetail/'.$atim_menu_variables['Participant.id'].'/'.$atim_menu_variables['TreatmentMaster.id'].'/');
