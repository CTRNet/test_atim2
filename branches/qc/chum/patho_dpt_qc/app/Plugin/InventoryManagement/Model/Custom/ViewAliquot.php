...
IFNULL(AliquotDetailBlock.chum_patho_default_category, IFNULL(AliquotDetailCore.chum_patho_category, "")) AS chum_patho_category,
...
LEFT JOIN sd_spe_tissues AS SampleDetail ON SampleDetail.sample_master_id=SampleMaster.id
LEFT JOIN ad_blocks AliquotDetailBlock ON AliquotDetailBlock.aliquot_master_id = AliquotMaster.id
LEFT JOIN ad_tissue_cores AliquotDetailCore ON AliquotDetailCore.aliquot_master_id = AliquotMaster.id
