...
{
    const chum_biotransit_DATETIME_REMOVE_FROM_STORAGE = 19;
    const chum_biotransit_TIME_PACKAGED = 19;
   ...
   public static $tableCreateQuery = "CREATE TABLE view_aliquot_uses (
		  ...
		  chum_biotransit_datetime_remove_from_storage datetime DEFAULT NULL,   
		  chum_biotransit_datetime_remove_from_storage_accuracy char(1) DEFAULT NULL,
		  chum_biotransit_time_packaged time DEFAULT NULL,
    ...
    public static $tableQuery = "SELECT CONCAT(AliquotInternalUse.id,6) AS id,
		...
		AliquotInternalUse.chum_biotransit_datetime_remove_from_storage AS chum_biotransit_datetime_remove_from_storage,
        AliquotInternalUse.chum_biotransit_datetime_remove_from_storage_accuracy AS chum_biotransit_datetime_remove_from_storage_accuracy,
        AliquotInternalUse.chum_biotransit_time_packaged AS chum_biotransit_time_packaged,
		...
		NULL AS chum_biotransit_datetime_remove_from_storage,
        NULL AS chum_biotransit_datetime_remove_from_storage_accuracy,
        NULL AS chum_biotransit_time_packaged,
        NULL AS `duration`,
		'' AS `duration_unit`,
