<?php
	...
	$structure_links = array(
		'index'=>array('detail'=>'/administrate/groups/detail/'.$atim_menu_variables['Bank.id'].'/%%Group.id%%'),
		'bottom'=>array('add'=>'/administrate/groups/add/'.$atim_menu_variables['Bank.id'])
	);
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'detail', $group['Group']['id'])); ?>
