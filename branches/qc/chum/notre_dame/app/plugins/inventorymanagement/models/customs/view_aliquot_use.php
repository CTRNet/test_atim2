	...
	function findFastFromAliquotMasterId($aliquot_master_id){
		$models_details = array(
			"SourceAliquot" => array(
				...
				self::USE_CODE			=> "CONCAT(SampleMaster.sample_label, ' (', SampleMaster.sample_code,')')",
				self::USE_DETAIL		=> '""',
				...
				self::USE_CODE			=> "CONCAT(AliquotMasterChildren.aliquot_label,' (',AliquotMasterChildren.barcode,')')",
				self::USE_DETAIL		=> '""',
