<?php
	$links = array(
		'top' 			=> '/InventoryManagement/OvcareTests/add/'.$atim_menu_variables['SampleMaster.id'],
		'bottom'		=> array(
			'cancel'	=> '/InventoryManagement/OvcareTests/listAll/'
	...
	$final_options = array(
		...
		'data'	=> array(),
		'settings' => array(
			'header' => __('ovcare test creation process') . ' - ' . __('tested aliquot selection'),
			'pagination'	=> false,
			'form_inputs'	=> false,
			'actions'		=> false,
			'form_bottom'	=> false
