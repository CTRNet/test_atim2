...
$children_structure = $ov_test_structure;
$children_structure_w_vol = $ov_test_volume_structure;
...
$links = array(
	'top' 		=> '/InventoryManagement/OvcareTests/add/'.$sample_master_id_parameter,
...
$options_parent = array(
	...
	'links'		=> $links,
	'settings'	=> array(
		'header'		=> __('ovcare test creation process') . ' - ' . __('creation'),
		'form_top'		=> false,
		'actions'		=> false,
		'form_bottom'	=> false,
		'stretch'		=> false,
...
$options_children = array(
	...
	'settings'	=> array(
		...
		"add_fields"	=> true, 
		"del_fields"	=> true,
		"language_heading" => __('ovcare tests'),
		'section_end'	=> true
	)
);
