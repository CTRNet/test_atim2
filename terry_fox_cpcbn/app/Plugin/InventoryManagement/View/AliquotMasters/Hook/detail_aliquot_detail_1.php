<?php 
	...
	unset($final_options['links']['bottom']['create derivative']);
	unset($structure_links['bottom']['create derivative']);
	unset($final_options['links']['bottom']['add uses/events']);
	unset($structure_links['bottom']['add uses/events']);
	unset($final_options['links']['bottom']['realiquoting']);
	unset($structure_links['bottom']['realiquoting']);
