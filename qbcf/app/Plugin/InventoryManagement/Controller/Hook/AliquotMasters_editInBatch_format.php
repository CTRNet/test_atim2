...
if($tmpQbcfAliquotMasterIds) {
    $tmpAliquotControls = $this->AliquotMaster->find('all', array('conditions' => array('AliquotMaster.id' => $tmpQbcfAliquotMasterIds), 'fields' => array("DISTINCT CONCAT(SampleControl.sample_type,'-',AliquotControl.aliquot_type) AS sample_aliquot_types")));
