    ...
    public function updateAliquotLabel($collectionIds, $acquireBatchViewsUpdateLock = false)
    {
        ...
        if ($collectionIds) {
            ...
            if ($collectionIds) {
                ...
                if ($acquireBatchViewsUpdateLock)
                    ...
                    if ($newAliquot['Collection']['collection_property'] == 'participant collection') {
                        switch ($newAliquot['AliquotControl']['aliquot_type']) {
                            case 'block':
                                ...
                                break;
                            case 'core':
                                $suffix = strlen($newAliquot['CoreAliquotDetail']['qbcf_core_nature_revised']) ? $newAliquot['CoreAliquotDetail']['qbcf_core_nature_revised'] : (strlen($newAliquot['CoreAliquotDetail']['qbcf_core_nature_site']) ? $newAliquot['CoreAliquotDetail']['qbcf_core_nature_site'] : 'U');
                                if (strlen($suffix)) {
