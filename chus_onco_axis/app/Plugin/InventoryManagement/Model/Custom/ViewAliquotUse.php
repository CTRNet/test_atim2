...
CONCAT(Bank.name, '-', Collection.acquisition_label, ' [',SampleMaster.sample_code,']') AS use_code,
		'' AS `use_details`,
...
JOIN collections AS Collection ON Collection.id = SampleMaster.collection_id
JOIN banks AS Bank ON Bank.id = Collection.bank_id
...
CONCAT(Bank.name, '-', Collection.acquisition_label, ' [',QualityCtrl.id,']') AS use_code,
		'' AS use_details,
...
CONCAT(Bank.name, '-', Collection.acquisition_label, ' [',AliquotReviewMaster.id,']') AS use_code,
		'' AS use_details,
		NULL AS used_volume,
		'' AS aliquot_volume_unit,
